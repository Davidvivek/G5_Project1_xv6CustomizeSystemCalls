...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	35e58593          	addi	a1,a1,862 # 1370 <malloc+0x106>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	32c58593          	addi	a1,a1,812 # 1380 <malloc+0x116>
      5c:	4509                	li	a0,2
      5e:	12e010ef          	jal	118c <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	30650513          	addi	a0,a0,774 # 1388 <malloc+0x11e>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      b0:	3dc70713          	addi	a4,a4,988 # 1488 <malloc+0x21e>
    ...
    panic("runcmd");
      ...
      ca:	2ca50513          	addi	a0,a0,714 # 1390 <malloc+0x126>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      f4:	2a858593          	addi	a1,a1,680 # 1398 <malloc+0x12e>
      f8:	4509                	li	a0,2
      fa:	092010ef          	jal	118c <fprintf>
  exit(0);
      fe:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     158:	25458593          	addi	a1,a1,596 # 13a8 <malloc+0x13e>
     15c:	4509                	li	a0,2
     15e:	02e010ef          	jal	118c <fprintf>
      exit(1);
     162:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1ba:	20250513          	addi	a0,a0,514 # 13b8 <malloc+0x14e>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     514:	ed0a8a93          	addi	s5,s5,-304 # 13e0 <malloc+0x176>
  ...
  while(peek(ps, es, "<>")){
     ...
     526:	e9e50513          	addi	a0,a0,-354 # 13c0 <malloc+0x156>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     5e2:	e0a60613          	addi	a2,a2,-502 # 13e8 <malloc+0x17e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     612:	dfab0b13          	addi	s6,s6,-518 # 1408 <malloc+0x19e>
  ...
  return ret;
     ...
     63c:	db850513          	addi	a0,a0,-584 # 13f0 <malloc+0x186>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     68e:	d6e50513          	addi	a0,a0,-658 # 13f8 <malloc+0x18e>
...
00000000000006b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     6cc:	d4860613          	addi	a2,a2,-696 # 1410 <malloc+0x1a6>
     6d0:	85ce                	mv	a1,s3
     6d2:	854a                	mv	a0,s2
...
000000000000070a <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     728:	cf4a0a13          	addi	s4,s4,-780 # 1418 <malloc+0x1ae>
  ...
  if(peek(ps, es, ";")){
     ...
     752:	cd260613          	addi	a2,a2,-814 # 1420 <malloc+0x1b6>
     756:	85ce                	mv	a1,s3
     758:	854a                	mv	a0,s2
...
0000000000000792 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     7a8:	c4460613          	addi	a2,a2,-956 # 13e8 <malloc+0x17e>
  ...
  if(!peek(ps, es, ")"))
     ...
     7cc:	c7060613          	addi	a2,a2,-912 # 1438 <malloc+0x1ce>
     7d0:	85ca                	mv	a1,s2
     7d2:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     802:	c2a50513          	addi	a0,a0,-982 # 1428 <malloc+0x1be>
     806:	845ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     80a:	00001517          	auipc	a0,0x1
     80e:	c3650513          	addi	a0,a0,-970 # 1440 <malloc+0x1d6>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     836:	c6e70713          	addi	a4,a4,-914 # 14a0 <malloc+0x236>
...
0000000000000896 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     8c2:	aba60613          	addi	a2,a2,-1350 # 1378 <malloc+0x10e>
     8c6:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8f0:	b6c58593          	addi	a1,a1,-1172 # 1458 <malloc+0x1ee>
     8f4:	4509                	li	a0,2
     8f6:	097000ef          	jal	118c <fprintf>
    panic("syntax");
     8fa:	00001517          	auipc	a0,0x1
     8fe:	af650513          	addi	a0,a0,-1290 # 13f0 <malloc+0x186>
...
0000000000000906 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     91e:	b4e48493          	addi	s1,s1,-1202 # 1468 <malloc+0x1fe>
     922:	4589                	li	a1,2
     924:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     9c2:	ab258593          	addi	a1,a1,-1358 # 1470 <malloc+0x206>
     9c6:	4509                	li	a0,2
     9c8:	7c4000ef          	jal	118c <fprintf>
...
0000000000000da2 <getppid>:
.global getppid
getppid:
 li a7, SYS_getppid
     da2:	02100893          	li	a7,33
 ecall
     da6:	00000073          	ecall
 ret
     daa:	8082                	ret
...
ps:
 li a7, SYS_ps
     dac:	02200893          	li	a7,34
 ecall
     db0:	00000073          	ecall
 ret
     db4:	8082                	ret

0000000000000db6 <trace>:
.global trace
trace:
 li a7, SYS_trace
     db6:	02300893          	li	a7,35
 ecall
     dba:	00000073          	ecall
 ret
     dbe:	8082                	ret

0000000000000dc0 <waitx>:
.global waitx
waitx:
 li a7, SYS_waitx
     dc0:	02400893          	li	a7,36
 ecall
     dc4:	00000073          	ecall
 ret
     dc8:	8082                	ret

0000000000000dca <getcount>:
.global getcount
getcount:
 li a7, SYS_getcount
     dca:	02500893          	li	a7,37
 ecall
     dce:	00000073          	ecall
 ret
     dd2:	8082                	ret

0000000000000dd4 <getcwd>:
.global getcwd
getcwd:
 li a7, SYS_getcwd
     dd4:	48d9                	li	a7,22
...
0000000000000e0c <getprocessinfo>:
...
0000000000000e24 <shmdetach>:
.global shmdetach
shmdetach:
 li a7, SYS_shmdetach
     e24:	02000893          	li	a7,32
 ecall
     e28:	00000073          	ecall
 ret
     e2c:	8082                	ret

0000000000000e2e <putc>:
...
putc(int fd, char c)
{
     ...
     e36:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     e3a:	4605                	li	a2,1
     e3c:	fef40593          	addi	a1,s0,-17
     e40:	ee3ff0ef          	jal	d22 <write>
}
     e44:	60e2                	ld	ra,24(sp)
     e46:	6442                	ld	s0,16(sp)
     e48:	6105                	addi	sp,sp,32
     e4a:	8082                	ret

0000000000000e4c <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
     e4c:	715d                	addi	sp,sp,-80
     e4e:	e486                	sd	ra,72(sp)
     e50:	e0a2                	sd	s0,64(sp)
     e52:	f84a                	sd	s2,48(sp)
     e54:	0880                	addi	s0,sp,80
     e56:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
     e58:	c299                	beqz	a3,e5e <printint+0x12>
     e5a:	0805c363          	bltz	a1,ee0 <printint+0x94>
  neg = 0;
     e5e:	4881                	li	a7,0
     e60:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     e66:	00000517          	auipc	a0,0x0
     e6a:	65250513          	addi	a0,a0,1618 # 14b8 <digits>
     e6e:	883e                	mv	a6,a5
     e70:	2785                	addiw	a5,a5,1
     e72:	02c5f733          	remu	a4,a1,a2
     e76:	972a                	add	a4,a4,a0
     e78:	00074703          	lbu	a4,0(a4)
     e7c:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     e80:	872e                	mv	a4,a1
     e82:	02c5d5b3          	divu	a1,a1,a2
     e86:	0685                	addi	a3,a3,1
     e88:	fec773e3          	bgeu	a4,a2,e6e <printint+0x22>
  if(neg)
     e8c:	00088b63          	beqz	a7,ea2 <printint+0x56>
    buf[i++] = '-';
     e90:	fd078793          	addi	a5,a5,-48
     e94:	97a2                	add	a5,a5,s0
     e96:	02d00713          	li	a4,45
     e9a:	fee78423          	sb	a4,-24(a5)
     e9e:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     ea2:	02f05a63          	blez	a5,ed6 <printint+0x8a>
     ea6:	fc26                	sd	s1,56(sp)
     ea8:	f44e                	sd	s3,40(sp)
     eaa:	fb840713          	addi	a4,s0,-72
     eae:	00f704b3          	add	s1,a4,a5
     eb2:	fff70993          	addi	s3,a4,-1
     eb6:	99be                	add	s3,s3,a5
     eb8:	37fd                	addiw	a5,a5,-1
     eba:	1782                	slli	a5,a5,0x20
     ebc:	9381                	srli	a5,a5,0x20
     ebe:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     ec2:	fff4c583          	lbu	a1,-1(s1)
     ec6:	854a                	mv	a0,s2
     ec8:	f67ff0ef          	jal	e2e <putc>
  while(--i >= 0)
     ecc:	14fd                	addi	s1,s1,-1
     ece:	ff349ae3          	bne	s1,s3,ec2 <printint+0x76>
     ed2:	74e2                	ld	s1,56(sp)
     ed4:	79a2                	ld	s3,40(sp)
}
     ed6:	60a6                	ld	ra,72(sp)
     ed8:	6406                	ld	s0,64(sp)
     eda:	7942                	ld	s2,48(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     ef6:	28090663          	beqz	s2,1182 <vprintf+0x29a>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f3e:	22090a63          	beqz	s2,1172 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    ...
    if(state == 0){
     ...
     f60:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     f64:	05878363          	beq	a5,s8,faa <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     f68:	05978d63          	beq	a5,s9,fc2 <vprintf+0xda>
     ...
     f70:	0ee78763          	beq	a5,a4,105e <vprintf+0x176>
     ...
     f78:	12e78963          	beq	a5,a4,10aa <vprintf+0x1c2>
     ...
     f80:	14e78e63          	beq	a5,a4,10dc <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     f84:	06300713          	li	a4,99
     f88:	18e78e63          	beq	a5,a4,1124 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     f8c:	07300713          	li	a4,115
     f90:	1ae78463          	beq	a5,a4,1138 <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     f94:	02500713          	li	a4,37
     f98:	04e79563          	bne	a5,a4,fe2 <vprintf+0xfa>
        putc(fd, '%');
     f9c:	02500593          	li	a1,37
     fa0:	855a                	mv	a0,s6
     fa2:	e8dff0ef          	jal	e2e <putc>
      ...
      state = 0;
     fa6:	4981                	li	s3,0
     fa8:	b769                	j	f32 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
     faa:	008b8913          	addi	s2,s7,8
     fae:	4685                	li	a3,1
     fb0:	4629                	li	a2,10
     fb2:	000ba583          	lw	a1,0(s7)
     fb6:	855a                	mv	a0,s6
     fb8:	e95ff0ef          	jal	e4c <printint>
     fbc:	8bca                	mv	s7,s2
      state = 0;
     fbe:	4981                	li	s3,0
     fc0:	bf8d                	j	f32 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     fc2:	06400793          	li	a5,100
     fc6:	02f68963          	beq	a3,a5,ff8 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     fca:	06c00793          	li	a5,108
     fce:	04f68263          	beq	a3,a5,1012 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     fd2:	07500793          	li	a5,117
     fd6:	0af68063          	beq	a3,a5,1076 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     fda:	07800793          	li	a5,120
     fde:	0ef68263          	beq	a3,a5,10c2 <vprintf+0x1da>
        putc(fd, '%');
     fe2:	02500593          	li	a1,37
     fe6:	855a                	mv	a0,s6
     fe8:	e47ff0ef          	jal	e2e <putc>
        putc(fd, c0);
     fec:	85ca                	mv	a1,s2
     fee:	855a                	mv	a0,s6
     ff0:	e3fff0ef          	jal	e2e <putc>
      state = 0;
     ff4:	4981                	li	s3,0
     ff6:	bf35                	j	f32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    1004:	855a                	mv	a0,s6
    1006:	e47ff0ef          	jal	e4c <printint>
        i += 1;
    100a:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    100c:	8bca                	mv	s7,s2
      state = 0;
    100e:	4981                	li	s3,0
        i += 1;
    1010:	b70d                	j	f32 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    1012:	06400793          	li	a5,100
    1016:	02f60763          	beq	a2,a5,1044 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    101a:	07500793          	li	a5,117
    101e:	06f60963          	beq	a2,a5,1090 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    1022:	07800793          	li	a5,120
    1026:	faf61ee3          	bne	a2,a5,fe2 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    1036:	855a                	mv	a0,s6
    1038:	e15ff0ef          	jal	e4c <printint>
        i += 2;
    103c:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    103e:	8bca                	mv	s7,s2
      state = 0;
    1040:	4981                	li	s3,0
        i += 2;
    1042:	bdc5                	j	f32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    1050:	855a                	mv	a0,s6
    1052:	dfbff0ef          	jal	e4c <printint>
        i += 2;
    ...
    106a:	855a                	mv	a0,s6
    106c:	de1ff0ef          	jal	e4c <printint>
    1070:	8bca                	mv	s7,s2
      state = 0;
    1072:	4981                	li	s3,0
    1074:	bd7d                	j	f32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    1082:	855a                	mv	a0,s6
    1084:	dc9ff0ef          	jal	e4c <printint>
        i += 1;
    ...
    109c:	855a                	mv	a0,s6
    109e:	dafff0ef          	jal	e4c <printint>
        i += 2;
    10a2:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    10a4:	8bca                	mv	s7,s2
      state = 0;
    10a6:	4981                	li	s3,0
        i += 2;
    10a8:	b569                	j	f32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    10aa:	008b8913          	addi	s2,s7,8
    10ae:	4681                	li	a3,0
    10b0:	4641                	li	a2,16
    10b2:	000be583          	lwu	a1,0(s7)
    10b6:	855a                	mv	a0,s6
    10b8:	d95ff0ef          	jal	e4c <printint>
    10bc:	8bca                	mv	s7,s2
      state = 0;
    10be:	4981                	li	s3,0
    10c0:	bd8d                	j	f32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    10c2:	008b8913          	addi	s2,s7,8
    10c6:	4681                	li	a3,0
    10c8:	4641                	li	a2,16
    10ca:	000bb583          	ld	a1,0(s7)
    10ce:	855a                	mv	a0,s6
    10d0:	d7dff0ef          	jal	e4c <printint>
        i += 1;
    ...
    10d8:	4981                	li	s3,0
        i += 1;
    10da:	bda1                	j	f32 <vprintf+0x4a>
    10dc:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    10de:	008b8d13          	addi	s10,s7,8
    10e2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    10e6:	03000593          	li	a1,48
    10ea:	855a                	mv	a0,s6
    10ec:	d43ff0ef          	jal	e2e <putc>
  putc(fd, 'x');
    10f0:	07800593          	li	a1,120
    10f4:	855a                	mv	a0,s6
    10f6:	d39ff0ef          	jal	e2e <putc>
    10fa:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10fc:	00000b97          	auipc	s7,0x0
    1100:	3bcb8b93          	addi	s7,s7,956 # 14b8 <digits>
    1104:	03c9d793          	srli	a5,s3,0x3c
    1108:	97de                	add	a5,a5,s7
    110a:	0007c583          	lbu	a1,0(a5)
    110e:	855a                	mv	a0,s6
    1110:	d1fff0ef          	jal	e2e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1114:	0992                	slli	s3,s3,0x4
    1116:	397d                	addiw	s2,s2,-1
    1118:	fe0916e3          	bnez	s2,1104 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    111c:	8bea                	mv	s7,s10
      state = 0;
    111e:	4981                	li	s3,0
    1120:	6d02                	ld	s10,0(sp)
    1122:	bd01                	j	f32 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    1124:	008b8913          	addi	s2,s7,8
    1128:	000bc583          	lbu	a1,0(s7)
    112c:	855a                	mv	a0,s6
    112e:	d01ff0ef          	jal	e2e <putc>
    1132:	8bca                	mv	s7,s2
      state = 0;
    1134:	4981                	li	s3,0
    1136:	bbf5                	j	f32 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    1138:	008b8993          	addi	s3,s7,8
    113c:	000bb903          	ld	s2,0(s7)
    1140:	00090f63          	beqz	s2,115e <vprintf+0x276>
        for(; *s; s++)
    1144:	00094583          	lbu	a1,0(s2)
    1148:	c195                	beqz	a1,116c <vprintf+0x284>
          putc(fd, *s);
    114a:	855a                	mv	a0,s6
    114c:	ce3ff0ef          	jal	e2e <putc>
        for(; *s; s++)
    1150:	0905                	addi	s2,s2,1
    1152:	00094583          	lbu	a1,0(s2)
    1156:	f9f5                	bnez	a1,114a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1158:	8bce                	mv	s7,s3
      state = 0;
    115a:	4981                	li	s3,0
    115c:	bbd9                	j	f32 <vprintf+0x4a>
          s = "(null)";
    115e:	00000917          	auipc	s2,0x0
    1162:	32290913          	addi	s2,s2,802 # 1480 <malloc+0x216>
        for(; *s; s++)
    1166:	02800593          	li	a1,40
    116a:	b7c5                	j	114a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    116c:	8bce                	mv	s7,s3
      state = 0;
    116e:	4981                	li	s3,0
    1170:	b3c9                	j	f32 <vprintf+0x4a>
    1172:	64a6                	ld	s1,72(sp)
    1174:	79e2                	ld	s3,56(sp)
    1176:	7a42                	ld	s4,48(sp)
    1178:	7aa2                	ld	s5,40(sp)
    117a:	7b02                	ld	s6,32(sp)
    117c:	6be2                	ld	s7,24(sp)
    117e:	6c42                	ld	s8,16(sp)
    1180:	6ca2                	ld	s9,8(sp)
    }
  }
}
    1182:	60e6                	ld	ra,88(sp)
    1184:	6446                	ld	s0,80(sp)
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11f6:	e1e7b783          	ld	a5,-482(a5) # 2010 <freep>
    ...
    121e:	00e6ea63          	bltu	a3,a4,1232 <free+0x4a>
{
  ...
  freep = p;
    ...
    1260:	daf73a23          	sd	a5,-588(a4) # 2010 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1286:	00001517          	auipc	a0,0x1
    128a:	d8a53503          	ld	a0,-630(a0) # 2010 <freep>
    128e:	c915                	beqz	a0,12c2 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1294:	08977a63          	bgeu	a4,s1,1328 <malloc+0xbe>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    12b6:	00001917          	auipc	s2,0x1
    12ba:	d5a90913          	addi	s2,s2,-678 # 2010 <freep>
  if(p == SBRK_ERROR)
    12be:	5afd                	li	s5,-1
    12c0:	a081                	j	1300 <malloc+0x96>
    ...
    12ce:	dbe78793          	addi	a5,a5,-578 # 2088 <base>
    12d2:	00001717          	auipc	a4,0x1
    12d6:	d2f73f23          	sd	a5,-706(a4) # 2010 <freep>
    12da:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12dc:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12e0:	b7c1                	j	12a0 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    12e2:	6398                	ld	a4,0(a5)
    12e4:	e118                	sd	a4,0(a0)
    12e6:	a8a9                	j	1340 <malloc+0xd6>
  hp->s.size = nu;
    12e8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12ec:	0541                	addi	a0,a0,16
    12ee:	efbff0ef          	jal	11e8 <free>
  return freep;
    12f2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12f6:	c12d                	beqz	a0,1358 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12fa:	4798                	lw	a4,8(a5)
    12fc:	02977263          	bgeu	a4,s1,1320 <malloc+0xb6>
    if(p == freep)
    1300:	00093703          	ld	a4,0(s2)
    1304:	853e                	mv	a0,a5
    1306:	fef719e3          	bne	a4,a5,12f8 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    130a:	8552                	mv	a0,s4
    130c:	933ff0ef          	jal	c3e <sbrk>
  if(p == SBRK_ERROR)
    1310:	fd551ce3          	bne	a0,s5,12e8 <malloc+0x7e>
        return 0;
    1314:	4501                	li	a0,0
