...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	9e278793          	addi	a5,a5,-1566 # 79f0 <malloc+0x2684>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	40a50513          	addi	a0,a0,1034 # 5470 <malloc+0x104>
      6e:	24a050ef          	jal	52b8 <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	3f050513          	addi	a0,a0,1008 # 5490 <malloc+0x124>
      a8:	210050ef          	jal	52b8 <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	3e850513          	addi	a0,a0,1000 # 54a8 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	3f250513          	addi	a0,a0,1010 # 54c8 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	3be50513          	addi	a0,a0,958 # 54b0 <malloc+0x144>
      fa:	1be050ef          	jal	52b8 <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	3d250513          	addi	a0,a0,978 # 54d8 <malloc+0x16c>
     10e:	1aa050ef          	jal	52b8 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	38450513          	addi	a0,a0,900 # 5500 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	37a50513          	addi	a0,a0,890 # 5520 <malloc+0x1b4>
     1ae:	10a050ef          	jal	52b8 <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	30450513          	addi	a0,a0,772 # 5548 <malloc+0x1dc>
     24c:	409040ef          	jal	4e54 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	2f4a8a93          	addi	s5,s5,756 # 5548 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	29650513          	addi	a0,a0,662 # 5558 <malloc+0x1ec>
     2ca:	7ef040ef          	jal	52b8 <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	29c50513          	addi	a0,a0,668 # 5578 <malloc+0x20c>
     2e4:	7d5040ef          	jal	52b8 <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	29250513          	addi	a0,a0,658 # 5590 <malloc+0x224>
     306:	34f040ef          	jal	4e54 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	28298993          	addi	s3,s3,642 # 5590 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	24650513          	addi	a0,a0,582 # 5590 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	1ba58593          	addi	a1,a1,442 # 5518 <malloc+0x1ac>
     366:	2bf040ef          	jal	4e24 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	24050513          	addi	a0,a0,576 # 55b0 <malloc+0x244>
     378:	741040ef          	jal	52b8 <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	287040ef          	jal	4e04 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	21650513          	addi	a0,a0,534 # 5598 <malloc+0x22c>
     38a:	72f040ef          	jal	52b8 <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	275040ef          	jal	4e04 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	20450513          	addi	a0,a0,516 # 5598 <malloc+0x22c>
     39c:	71d040ef          	jal	52b8 <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	1e450513          	addi	a0,a0,484 # 5590 <malloc+0x224>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	56078793          	addi	a5,a5,1376 # 79f0 <malloc+0x2684>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	102a0a13          	addi	s4,s4,258 # 55c0 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	08450513          	addi	a0,a0,132 # 55c8 <malloc+0x25c>
     54c:	56d040ef          	jal	52b8 <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	08650513          	addi	a0,a0,134 # 55e0 <malloc+0x274>
     562:	557040ef          	jal	52b8 <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	0a050513          	addi	a0,a0,160 # 5610 <malloc+0x2a4>
     578:	541040ef          	jal	52b8 <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	087040ef          	jal	4e04 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	0be50513          	addi	a0,a0,190 # 5640 <malloc+0x2d4>
     58a:	52f040ef          	jal	52b8 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	0b850513          	addi	a0,a0,184 # 5650 <malloc+0x2e4>
     5a0:	519040ef          	jal	52b8 <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	43278793          	addi	a5,a5,1074 # 79f0 <malloc+0x2684>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	08ea0a13          	addi	s4,s4,142 # 5680 <malloc+0x314>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	f1ea8a93          	addi	s5,s5,-226 # 5518 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	00a50513          	addi	a0,a0,10 # 5688 <malloc+0x31c>
     686:	433040ef          	jal	52b8 <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	00c50513          	addi	a0,a0,12 # 56a0 <malloc+0x334>
     69c:	41d040ef          	jal	52b8 <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	762040ef          	jal	4e04 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	f9a50513          	addi	a0,a0,-102 # 5640 <malloc+0x2d4>
     6ae:	40b040ef          	jal	52b8 <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	750040ef          	jal	4e04 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	01850513          	addi	a0,a0,24 # 56d0 <malloc+0x364>
     6c0:	3f9040ef          	jal	52b8 <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	01a50513          	addi	a0,a0,26 # 56e8 <malloc+0x37c>
     6d6:	3e3040ef          	jal	52b8 <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	dd850513          	addi	a0,a0,-552 # 5500 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	db450513          	addi	a0,a0,-588 # 5500 <malloc+0x194>
     754:	6f0040ef          	jal	4e44 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	da450513          	addi	a0,a0,-604 # 5500 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	fea58593          	addi	a1,a1,-22 # 5778 <malloc+0x40c>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	d3c50513          	addi	a0,a0,-708 # 5500 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	f2050513          	addi	a0,a0,-224 # 5718 <malloc+0x3ac>
     800:	2b9040ef          	jal	52b8 <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	f2c50513          	addi	a0,a0,-212 # 5738 <malloc+0x3cc>
     814:	2a5040ef          	jal	52b8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	f2c50513          	addi	a0,a0,-212 # 5748 <malloc+0x3dc>
     824:	295040ef          	jal	52b8 <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	f3850513          	addi	a0,a0,-200 # 5768 <malloc+0x3fc>
     838:	281040ef          	jal	52b8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	f0850513          	addi	a0,a0,-248 # 5748 <malloc+0x3dc>
     848:	271040ef          	jal	52b8 <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	f2a50513          	addi	a0,a0,-214 # 5780 <malloc+0x414>
     85e:	25b040ef          	jal	52b8 <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	f3450513          	addi	a0,a0,-204 # 57a0 <malloc+0x434>
     874:	245040ef          	jal	52b8 <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	f2850513          	addi	a0,a0,-216 # 57c0 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	f3c98993          	addi	s3,s3,-196 # 57e8 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	f6ca8a93          	addi	s5,s5,-148 # 5820 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	ed250513          	addi	a0,a0,-302 # 57c0 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     922:	ea250513          	addi	a0,a0,-350 # 57c0 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	e8450513          	addi	a0,a0,-380 # 57c8 <malloc+0x45c>
     94c:	16d040ef          	jal	52b8 <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	e9e50513          	addi	a0,a0,-354 # 57f8 <malloc+0x48c>
     962:	157040ef          	jal	52b8 <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	ec050513          	addi	a0,a0,-320 # 5830 <malloc+0x4c4>
     978:	141040ef          	jal	52b8 <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	ed450513          	addi	a0,a0,-300 # 5858 <malloc+0x4ec>
     98c:	12d040ef          	jal	52b8 <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	ee050513          	addi	a0,a0,-288 # 5878 <malloc+0x50c>
     9a0:	119040ef          	jal	52b8 <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	ee450513          	addi	a0,a0,-284 # 5890 <malloc+0x524>
     9b4:	105040ef          	jal	52b8 <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	eda50513          	addi	a0,a0,-294 # 58b0 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	e9450513          	addi	a0,a0,-364 # 58b0 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	e5c50513          	addi	a0,a0,-420 # 58b8 <malloc+0x54c>
     a64:	055040ef          	jal	52b8 <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	e6650513          	addi	a0,a0,-410 # 58d8 <malloc+0x56c>
     a7a:	03f040ef          	jal	52b8 <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	e7a50513          	addi	a0,a0,-390 # 5900 <malloc+0x594>
     a8e:	02b040ef          	jal	52b8 <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	e0a50513          	addi	a0,a0,-502 # 58b0 <malloc+0x544>
     ...
     ad0:	e5450513          	addi	a0,a0,-428 # 5920 <malloc+0x5b4>
     ad4:	7e4040ef          	jal	52b8 <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	e6650513          	addi	a0,a0,-410 # 5948 <malloc+0x5dc>
     aea:	7ce040ef          	jal	52b8 <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	e6850513          	addi	a0,a0,-408 # 5960 <malloc+0x5f4>
     b00:	7b8040ef          	jal	52b8 <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	e7c50513          	addi	a0,a0,-388 # 5988 <malloc+0x61c>
     b14:	7a4040ef          	jal	52b8 <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	e6e50513          	addi	a0,a0,-402 # 59a0 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	e8a58593          	addi	a1,a1,-374 # 59d0 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	e4650513          	addi	a0,a0,-442 # 59a0 <malloc+0x634>
  ...
  unlink("unlinkread");
     ...
     be6:	dbe50513          	addi	a0,a0,-578 # 59a0 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	db250513          	addi	a0,a0,-590 # 59b0 <malloc+0x644>
     c06:	6b2040ef          	jal	52b8 <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	dc650513          	addi	a0,a0,-570 # 59d8 <malloc+0x66c>
     c1a:	69e040ef          	jal	52b8 <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	dd250513          	addi	a0,a0,-558 # 59f8 <malloc+0x68c>
     c2e:	68a040ef          	jal	52b8 <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	de650513          	addi	a0,a0,-538 # 5a20 <malloc+0x6b4>
     c42:	676040ef          	jal	52b8 <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	df250513          	addi	a0,a0,-526 # 5a40 <malloc+0x6d4>
     c56:	662040ef          	jal	52b8 <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	dfe50513          	addi	a0,a0,-514 # 5a60 <malloc+0x6f4>
     c6a:	64e040ef          	jal	52b8 <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	dfe50513          	addi	a0,a0,-514 # 5a80 <malloc+0x714>
     c8a:	1ca040ef          	jal	4e54 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	dfa50513          	addi	a0,a0,-518 # 5a88 <malloc+0x71c>
     c96:	1be040ef          	jal	4e54 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	de250513          	addi	a0,a0,-542 # 5a80 <malloc+0x714>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	d1e58593          	addi	a1,a1,-738 # 59d0 <malloc+0x664>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	d0650513          	addi	a0,a0,-762 # 5a90 <malloc+0x724>
     d92:	526040ef          	jal	52b8 <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	d0a50513          	addi	a0,a0,-758 # 5aa8 <malloc+0x73c>
     da6:	512040ef          	jal	52b8 <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	d0e50513          	addi	a0,a0,-754 # 5ac0 <malloc+0x754>
     dba:	4fe040ef          	jal	52b8 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	d1a50513          	addi	a0,a0,-742 # 5ae0 <malloc+0x774>
     dce:	4ea040ef          	jal	52b8 <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	d3650513          	addi	a0,a0,-714 # 5b10 <malloc+0x7a4>
     de2:	4d6040ef          	jal	52b8 <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	d3a50513          	addi	a0,a0,-710 # 5b28 <malloc+0x7bc>
     df6:	4c2040ef          	jal	52b8 <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	d3e50513          	addi	a0,a0,-706 # 5b40 <malloc+0x7d4>
     e0a:	4ae040ef          	jal	52b8 <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	d5250513          	addi	a0,a0,-686 # 5b68 <malloc+0x7fc>
     e1e:	49a040ef          	jal	52b8 <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	d6e50513          	addi	a0,a0,-658 # 5b98 <malloc+0x82c>
     e32:	486040ef          	jal	52b8 <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	d6498993          	addi	s3,s3,-668 # 5bb8 <malloc+0x84c>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	d3c50513          	addi	a0,a0,-708 # 5bc8 <malloc+0x85c>
     e94:	424040ef          	jal	52b8 <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	d3450513          	addi	a0,a0,-716 # 5be8 <malloc+0x87c>
     ebc:	799030ef          	jal	4e54 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	d2450513          	addi	a0,a0,-732 # 5be8 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	d0aa0a13          	addi	s4,s4,-758 # 5be8 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	cbc50513          	addi	a0,a0,-836 # 5be8 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	c5c50513          	addi	a0,a0,-932 # 5bf0 <malloc+0x884>
     f9c:	31c040ef          	jal	52b8 <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	c6250513          	addi	a0,a0,-926 # 5c10 <malloc+0x8a4>
     fb6:	302040ef          	jal	52b8 <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	c7650513          	addi	a0,a0,-906 # 5c38 <malloc+0x8cc>
     fca:	2ee040ef          	jal	52b8 <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	48e98993          	addi	s3,s3,1166 # 54a8 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	cf878793          	addi	a5,a5,-776 # 6d88 <malloc+0x1a1c>
  ...
  if(pid == 0){
    ...
    10e8:	90c78793          	addi	a5,a5,-1780 # 79f0 <malloc+0x2684>
    ...
    110c:	3a050513          	addi	a0,a0,928 # 54a8 <malloc+0x13c>
    ...
    1120:	bc450513          	addi	a0,a0,-1084 # 5ce0 <malloc+0x974>
    1124:	194040ef          	jal	52b8 <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	b2450513          	addi	a0,a0,-1244 # 5c58 <malloc+0x8ec>
    113c:	17c040ef          	jal	52b8 <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	b2c50513          	addi	a0,a0,-1236 # 5c78 <malloc+0x90c>
    1154:	164040ef          	jal	52b8 <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	b3250513          	addi	a0,a0,-1230 # 5c98 <malloc+0x92c>
    116e:	14a040ef          	jal	52b8 <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	b4250513          	addi	a0,a0,-1214 # 5cc0 <malloc+0x954>
    1186:	132040ef          	jal	52b8 <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	479030ef          	jal	4e04 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	15050513          	addi	a0,a0,336 # 72e0 <malloc+0x1f74>
    1198:	120040ef          	jal	52b8 <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	b3e50513          	addi	a0,a0,-1218 # 5d08 <malloc+0x99c>
    11d2:	0e6040ef          	jal	52b8 <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	31450513          	addi	a0,a0,788 # 5500 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    1216:	2eea0a13          	addi	s4,s4,750 # 5500 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	b4ea8a93          	addi	s5,s5,-1202 # 5d68 <malloc+0x9fc>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	ac250513          	addi	a0,a0,-1342 # 5d38 <malloc+0x9cc>
    127e:	03a040ef          	jal	52b8 <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	ac650513          	addi	a0,a0,-1338 # 5d50 <malloc+0x9e4>
    1292:	026040ef          	jal	52b8 <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	ad850513          	addi	a0,a0,-1320 # 5d78 <malloc+0xa0c>
    12a8:	010040ef          	jal	52b8 <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	242a0a13          	addi	s4,s4,578 # 5500 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	ad2a8a93          	addi	s5,s5,-1326 # 5d98 <malloc+0xa2c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	20050513          	addi	a0,a0,512 # 5500 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    131a:	a3a50513          	addi	a0,a0,-1478 # 5d50 <malloc+0x9e4>
    131e:	79b030ef          	jal	52b8 <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	a7450513          	addi	a0,a0,-1420 # 5da0 <malloc+0xa34>
    1334:	785030ef          	jal	52b8 <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	15e78793          	addi	a5,a5,350 # 54a8 <malloc+0x13c>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	a6a78793          	addi	a5,a5,-1430 # 5dc0 <malloc+0xa54>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	a6250513          	addi	a0,a0,-1438 # 5dc8 <malloc+0xa5c>
  ...
  if(pid == 0) {
    ...
    138e:	a3e50513          	addi	a0,a0,-1474 # 5dc8 <malloc+0xa5c>
    ...
    13a6:	a4650513          	addi	a0,a0,-1466 # 5de8 <malloc+0xa7c>
    13aa:	70f030ef          	jal	52b8 <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	98050513          	addi	a0,a0,-1664 # 5d38 <malloc+0x9cc>
    13c0:	6f9030ef          	jal	52b8 <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	a0450513          	addi	a0,a0,-1532 # 5dd0 <malloc+0xa64>
    13d4:	6e5030ef          	jal	52b8 <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	0c650513          	addi	a0,a0,198 # 54a8 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    140e:	9ee50513          	addi	a0,a0,-1554 # 5df8 <malloc+0xa8c>
    1412:	6a7030ef          	jal	52b8 <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	9f250513          	addi	a0,a0,-1550 # 5e10 <malloc+0xaa4>
    1426:	693030ef          	jal	52b8 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	99a50513          	addi	a0,a0,-1638 # 5dc8 <malloc+0xa5c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	42850513          	addi	a0,a0,1064 # 5878 <malloc+0x50c>
    1458:	661030ef          	jal	52b8 <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	8ec50513          	addi	a0,a0,-1812 # 5d50 <malloc+0x9e4>
    146c:	64d030ef          	jal	52b8 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	193030ef          	jal	4e04 <exit>
  unlink("echo-ok");
    1476:	00005517          	auipc	a0,0x5
    147a:	95250513          	addi	a0,a0,-1710 # 5dc8 <malloc+0xa5c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	98c50513          	addi	a0,a0,-1652 # 5e28 <malloc+0xabc>
    14a4:	615030ef          	jal	52b8 <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	8f850513          	addi	a0,a0,-1800 # 5e40 <malloc+0xad4>
    1550:	569030ef          	jal	52b8 <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	89650513          	addi	a0,a0,-1898 # 5e58 <malloc+0xaec>
    15ca:	4ef030ef          	jal	52b8 <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	89a50513          	addi	a0,a0,-1894 # 5e70 <malloc+0xb04>
    15de:	4db030ef          	jal	52b8 <printf>
          return;
    ...
    160a:	88250513          	addi	a0,a0,-1918 # 5e88 <malloc+0xb1c>
    160e:	4ab030ef          	jal	52b8 <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	86a50513          	addi	a0,a0,-1942 # 5ea8 <malloc+0xb3c>
    1646:	473030ef          	jal	52b8 <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	69850513          	addi	a0,a0,1688 # 5d38 <malloc+0x9cc>
    16a8:	411030ef          	jal	52b8 <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	80c50513          	addi	a0,a0,-2036 # 5ec0 <malloc+0xb54>
    16bc:	3fd030ef          	jal	52b8 <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	81050513          	addi	a0,a0,-2032 # 5ed8 <malloc+0xb6c>
    16d0:	3e9030ef          	jal	52b8 <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	61450513          	addi	a0,a0,1556 # 5d38 <malloc+0x9cc>
    172c:	38d030ef          	jal	52b8 <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	5fc50513          	addi	a0,a0,1532 # 5d38 <malloc+0x9cc>
    1744:	375030ef          	jal	52b8 <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	75e50513          	addi	a0,a0,1886 # 5ef8 <malloc+0xb8c>
    17a2:	317030ef          	jal	52b8 <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	65c030ef          	jal	4e04 <exit>
{
    ...
    17da:	73250513          	addi	a0,a0,1842 # 5f08 <malloc+0xb9c>
    17de:	2db030ef          	jal	52b8 <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	ad050513          	addi	a0,a0,-1328 # 72e0 <malloc+0x1f74>
    1818:	2a1030ef          	jal	52b8 <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	4a650513          	addi	a0,a0,1190 # 5d38 <malloc+0x9cc>
    189a:	21f030ef          	jal	52b8 <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	51a50513          	addi	a0,a0,1306 # 5dd0 <malloc+0xa64>
    18be:	1fb030ef          	jal	52b8 <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	61450513          	addi	a0,a0,1556 # 5f28 <malloc+0xbbc>
    191c:	19d030ef          	jal	52b8 <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	60850513          	addi	a0,a0,1544 # 5f40 <malloc+0xbd4>
    1940:	179030ef          	jal	52b8 <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	5de50513          	addi	a0,a0,1502 # 5f68 <malloc+0xbfc>
    1992:	127030ef          	jal	52b8 <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	af450513          	addi	a0,a0,-1292 # 5518 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	ac0b0b13          	addi	s6,s6,-1344 # 5518 <malloc+0x1ac>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	530c0c13          	addi	s8,s8,1328 # 5f90 <malloc+0xc24>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	2cc50513          	addi	a0,a0,716 # 5d38 <malloc+0x9cc>
    1a74:	045030ef          	jal	52b8 <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	4d450513          	addi	a0,a0,1236 # 5fe0 <malloc+0xc74>
    1b14:	7a4030ef          	jal	52b8 <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	47450513          	addi	a0,a0,1140 # 5f98 <malloc+0xc2c>
    1b2c:	78c030ef          	jal	52b8 <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	47850513          	addi	a0,a0,1144 # 5fb0 <malloc+0xc44>
    1b40:	778030ef          	jal	52b8 <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	47c50513          	addi	a0,a0,1148 # 5fc8 <malloc+0xc5c>
    1b54:	764030ef          	jal	52b8 <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	14e50513          	addi	a0,a0,334 # 5d38 <malloc+0x9cc>
    1bf2:	6c6030ef          	jal	52b8 <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	40450513          	addi	a0,a0,1028 # 6008 <malloc+0xc9c>
    1c0c:	6ac030ef          	jal	52b8 <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	0c650513          	addi	a0,a0,198 # 5d38 <malloc+0x9cc>
    1c7a:	63e030ef          	jal	52b8 <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	39250513          	addi	a0,a0,914 # 6028 <malloc+0xcbc>
    1c9e:	61a030ef          	jal	52b8 <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	35a50513          	addi	a0,a0,858 # 6040 <malloc+0xcd4>
    1cee:	5ca030ef          	jal	52b8 <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	03e50513          	addi	a0,a0,62 # 5d38 <malloc+0x9cc>
    1d02:	5b6030ef          	jal	52b8 <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	cce78793          	addi	a5,a5,-818 # 79f0 <malloc+0x2684>
  ...
  exit(0);
    ...
    1d8e:	2de50513          	addi	a0,a0,734 # 6068 <malloc+0xcfc>
    1d92:	526030ef          	jal	52b8 <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	f9a50513          	addi	a0,a0,-102 # 5d38 <malloc+0x9cc>
    1da6:	512030ef          	jal	52b8 <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	4d650513          	addi	a0,a0,1238 # 72e0 <malloc+0x1f74>
    1e12:	4a6030ef          	jal	52b8 <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	1ec50513          	addi	a0,a0,492 # 6088 <malloc+0xd1c>
    1ea4:	414030ef          	jal	52b8 <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	6c450513          	addi	a0,a0,1732 # 5578 <malloc+0x20c>
    1ebc:	3fc030ef          	jal	52b8 <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	e6078793          	addi	a5,a5,-416 # 6d88 <malloc+0x1a1c>
  ...
  if(ret != -1){
    ...
    1f66:	13e50513          	addi	a0,a0,318 # 60a0 <malloc+0xd34>
    1f6a:	34e030ef          	jal	52b8 <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	ce050513          	addi	a0,a0,-800 # 5c58 <malloc+0x8ec>
    1f80:	338030ef          	jal	52b8 <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	cea50513          	addi	a0,a0,-790 # 5c78 <malloc+0x90c>
    1f96:	322030ef          	jal	52b8 <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	cf250513          	addi	a0,a0,-782 # 5c98 <malloc+0x92c>
    1fae:	30a030ef          	jal	52b8 <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	d0450513          	addi	a0,a0,-764 # 5cc0 <malloc+0x954>
    1fc4:	2f4030ef          	jal	52b8 <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	0e850513          	addi	a0,a0,232 # 60e0 <malloc+0xd74>
  ...
  if(n >= 0){
    ...
    2024:	0e050513          	addi	a0,a0,224 # 6100 <malloc+0xd94>
    2028:	290030ef          	jal	52b8 <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	07250513          	addi	a0,a0,114 # 60a8 <malloc+0xd3c>
    203e:	27a030ef          	jal	52b8 <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	07650513          	addi	a0,a0,118 # 60c0 <malloc+0xd54>
    2052:	266030ef          	jal	52b8 <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	5ad020ef          	jal	4e04 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	08c50513          	addi	a0,a0,140 # 60e8 <malloc+0xd7c>
    2064:	254030ef          	jal	52b8 <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	06c50513          	addi	a0,a0,108 # 60e0 <malloc+0xd74>
    207c:	5d9020ef          	jal	4e54 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	5fe50513          	addi	a0,a0,1534 # 5680 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    20a8:	08c50513          	addi	a0,a0,140 # 6130 <malloc+0xdc4>
    20ac:	20c030ef          	jal	52b8 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	553020ef          	jal	4e04 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	5d250513          	addi	a0,a0,1490 # 5688 <malloc+0x31c>
    20be:	1fa030ef          	jal	52b8 <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	03850513          	addi	a0,a0,56 # 6158 <malloc+0xdec>
    2128:	190030ef          	jal	52b8 <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	00850513          	addi	a0,a0,8 # 6178 <malloc+0xe0c>
    2178:	140030ef          	jal	52b8 <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	01c50513          	addi	a0,a0,28 # 61d8 <malloc+0xe6c>
    21c4:	0f4030ef          	jal	52b8 <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	fc250513          	addi	a0,a0,-62 # 6198 <malloc+0xe2c>
    21de:	0da030ef          	jal	52b8 <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	fce50513          	addi	a0,a0,-50 # 61b8 <malloc+0xe4c>
    21f2:	0c6030ef          	jal	52b8 <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	f2650513          	addi	a0,a0,-218 # 61f8 <malloc+0xe8c>
    22da:	7df020ef          	jal	52b8 <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	f5a50513          	addi	a0,a0,-166 # 6240 <malloc+0xed4>
    22ee:	7cb020ef          	jal	52b8 <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	f6250513          	addi	a0,a0,-158 # 6260 <malloc+0xef4>
    2306:	7b3020ef          	jal	52b8 <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	f8a50513          	addi	a0,a0,-118 # 62a0 <malloc+0xf34>
    231e:	79b020ef          	jal	52b8 <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	fa650513          	addi	a0,a0,-90 # 62d0 <malloc+0xf64>
    2332:	787020ef          	jal	52b8 <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	fc650513          	addi	a0,a0,-58 # 6308 <malloc+0xf9c>
    234a:	76f020ef          	jal	52b8 <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	fc050513          	addi	a0,a0,-64 # 6330 <malloc+0xfc4>
    2378:	2cd020ef          	jal	4e44 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	fb250513          	addi	a0,a0,-78 # 6330 <malloc+0xfc4>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	f7a50513          	addi	a0,a0,-134 # 6338 <malloc+0xfcc>
    23c6:	6f3020ef          	jal	52b8 <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	f7e50513          	addi	a0,a0,-130 # 6350 <malloc+0xfe4>
    23da:	6df020ef          	jal	52b8 <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	a5a50513          	addi	a0,a0,-1446 # 5e40 <malloc+0xad4>
    23ee:	6cb020ef          	jal	52b8 <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	f6050513          	addi	a0,a0,-160 # 6368 <malloc+0xffc>
  ...
  close(fd);
    ...
    2444:	91050513          	addi	a0,a0,-1776 # 5d50 <malloc+0x9e4>
    2448:	671020ef          	jal	52b8 <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	e6a50513          	addi	a0,a0,-406 # 72e0 <malloc+0x1f74>
    247e:	63b020ef          	jal	52b8 <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	e3050513          	addi	a0,a0,-464 # 72e0 <malloc+0x1f74>
    24b8:	601020ef          	jal	52b8 <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	df050513          	addi	a0,a0,-528 # 72e0 <malloc+0x1f74>
    24f8:	5c1020ef          	jal	52b8 <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	cd050513          	addi	a0,a0,-816 # 72e0 <malloc+0x1f74>
    2618:	4a1020ef          	jal	52b8 <printf>
      exit(1);
    261c:	4505                	li	a0,1
    ...
    2654:	e5850513          	addi	a0,a0,-424 # 54a8 <malloc+0x13c>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	ebc78793          	addi	a5,a5,-324 # 5518 <malloc+0x1ac>
...
000000000000267a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	d4a50513          	addi	a0,a0,-694 # 63f0 <malloc+0x1084>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	dac50513          	addi	a0,a0,-596 # 6468 <malloc+0x10fc>
  ...
  unlink("12345678901234");
    ...
    2744:	c3050513          	addi	a0,a0,-976 # 6370 <malloc+0x1004>
    2748:	371020ef          	jal	52b8 <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	c6450513          	addi	a0,a0,-924 # 63b8 <malloc+0x104c>
    275c:	35d020ef          	jal	52b8 <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	cb850513          	addi	a0,a0,-840 # 6420 <malloc+0x10b4>
    2770:	349020ef          	jal	52b8 <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	d1c50513          	addi	a0,a0,-740 # 6498 <malloc+0x112c>
    2784:	335020ef          	jal	52b8 <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	d6850513          	addi	a0,a0,-664 # 64f8 <malloc+0x118c>
    2798:	321020ef          	jal	52b8 <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	dac50513          	addi	a0,a0,-596 # 6550 <malloc+0x11e4>
    27ac:	30d020ef          	jal	52b8 <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	d9c50513          	addi	a0,a0,-612 # 6588 <malloc+0x121c>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	d8050513          	addi	a0,a0,-640 # 6598 <malloc+0x122c>
    2820:	299020ef          	jal	52b8 <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	bfc50513          	addi	a0,a0,-1028 # 65b8 <malloc+0x124c>
    29c4:	0f5020ef          	jal	52b8 <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	bce50513          	addi	a0,a0,-1074 # 65f0 <malloc+0x1284>
    2a2a:	08f020ef          	jal	52b8 <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	bd250513          	addi	a0,a0,-1070 # 6608 <malloc+0x129c>
    2a3e:	07b020ef          	jal	52b8 <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	bee50513          	addi	a0,a0,-1042 # 6638 <malloc+0x12cc>
    2a52:	067020ef          	jal	52b8 <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	c0250513          	addi	a0,a0,-1022 # 6660 <malloc+0x12f4>
    2a66:	053020ef          	jal	52b8 <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	27a50513          	addi	a0,a0,634 # 5d38 <malloc+0x9cc>
    2ac6:	7f2020ef          	jal	52b8 <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	b1e50513          	addi	a0,a0,-1250 # 65f0 <malloc+0x1284>
    2ada:	7de020ef          	jal	52b8 <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	b9250513          	addi	a0,a0,-1134 # 6678 <malloc+0x130c>
    2aee:	7ca020ef          	jal	52b8 <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	b3e50513          	addi	a0,a0,-1218 # 6638 <malloc+0x12cc>
    2b02:	7b6020ef          	jal	52b8 <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	a7c50513          	addi	a0,a0,-1412 # 65f0 <malloc+0x1284>
    2b7c:	73c020ef          	jal	52b8 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	b1050513          	addi	a0,a0,-1264 # 6698 <malloc+0x132c>
    2b90:	728020ef          	jal	52b8 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	b1c50513          	addi	a0,a0,-1252 # 66b8 <malloc+0x134c>
    2ba4:	714020ef          	jal	52b8 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	b2050513          	addi	a0,a0,-1248 # 66d0 <malloc+0x1364>
    2bb8:	700020ef          	jal	52b8 <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	c4850513          	addi	a0,a0,-952 # 6818 <malloc+0x14ac>
    2bd8:	27c020ef          	jal	4e54 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	b0c50513          	addi	a0,a0,-1268 # 66e8 <malloc+0x137c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	b1850513          	addi	a0,a0,-1256 # 6708 <malloc+0x139c>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	c1458593          	addi	a1,a1,-1004 # 6818 <malloc+0x14ac>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	ad250513          	addi	a0,a0,-1326 # 66e8 <malloc+0x137c>
    2c1e:	236020ef          	jal	4e54 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	b3a50513          	addi	a0,a0,-1222 # 6760 <malloc+0x13f4>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	b4e50513          	addi	a0,a0,-1202 # 6788 <malloc+0x141c>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	b6a58593          	addi	a1,a1,-1174 # 67b8 <malloc+0x144c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	b5e50513          	addi	a0,a0,-1186 # 67c0 <malloc+0x1454>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	a4050513          	addi	a0,a0,-1472 # 6788 <malloc+0x141c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	c4450513          	addi	a0,a0,-956 # 69a0 <malloc+0x1634>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	82250513          	addi	a0,a0,-2014 # 66f0 <malloc+0x1384>
    2ed6:	3e2020ef          	jal	52b8 <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	82e50513          	addi	a0,a0,-2002 # 6710 <malloc+0x13a4>
    2eea:	3ce020ef          	jal	52b8 <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	83a50513          	addi	a0,a0,-1990 # 6730 <malloc+0x13c4>
    2efe:	3ba020ef          	jal	52b8 <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	85e50513          	addi	a0,a0,-1954 # 6768 <malloc+0x13fc>
    2f12:	3a6020ef          	jal	52b8 <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	87a50513          	addi	a0,a0,-1926 # 6798 <malloc+0x142c>
    2f26:	392020ef          	jal	52b8 <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	89e50513          	addi	a0,a0,-1890 # 67d0 <malloc+0x1464>
    2f3a:	37e020ef          	jal	52b8 <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	8aa50513          	addi	a0,a0,-1878 # 67f0 <malloc+0x1484>
    2f4e:	36a020ef          	jal	52b8 <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	8c650513          	addi	a0,a0,-1850 # 6820 <malloc+0x14b4>
    2f62:	356020ef          	jal	52b8 <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	8da50513          	addi	a0,a0,-1830 # 6848 <malloc+0x14dc>
    2f76:	342020ef          	jal	52b8 <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	8e650513          	addi	a0,a0,-1818 # 6868 <malloc+0x14fc>
    2f8a:	32e020ef          	jal	52b8 <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	8fa50513          	addi	a0,a0,-1798 # 6890 <malloc+0x1524>
    2f9e:	31a020ef          	jal	52b8 <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	90e50513          	addi	a0,a0,-1778 # 68b8 <malloc+0x154c>
    2fb2:	306020ef          	jal	52b8 <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	92a50513          	addi	a0,a0,-1750 # 68e8 <malloc+0x157c>
    2fc6:	2f2020ef          	jal	52b8 <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	94650513          	addi	a0,a0,-1722 # 6918 <malloc+0x15ac>
    2fda:	2de020ef          	jal	52b8 <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	94a50513          	addi	a0,a0,-1718 # 6930 <malloc+0x15c4>
    2fee:	2ca020ef          	jal	52b8 <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	95650513          	addi	a0,a0,-1706 # 6950 <malloc+0x15e4>
    3002:	2b6020ef          	jal	52b8 <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	96250513          	addi	a0,a0,-1694 # 6970 <malloc+0x1604>
    3016:	2a2020ef          	jal	52b8 <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	98e50513          	addi	a0,a0,-1650 # 69b0 <malloc+0x1644>
    302a:	28e020ef          	jal	52b8 <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	9aa50513          	addi	a0,a0,-1622 # 69e0 <malloc+0x1674>
    303e:	27a020ef          	jal	52b8 <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	9b650513          	addi	a0,a0,-1610 # 6a00 <malloc+0x1694>
    3052:	266020ef          	jal	52b8 <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	9c250513          	addi	a0,a0,-1598 # 6a20 <malloc+0x16b4>
    3066:	252020ef          	jal	52b8 <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	9ce50513          	addi	a0,a0,-1586 # 6a40 <malloc+0x16d4>
    307a:	23e020ef          	jal	52b8 <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	9ea50513          	addi	a0,a0,-1558 # 6a70 <malloc+0x1704>
    308e:	22a020ef          	jal	52b8 <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	9fe50513          	addi	a0,a0,-1538 # 6a98 <malloc+0x172c>
    30a2:	216020ef          	jal	52b8 <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	a1250513          	addi	a0,a0,-1518 # 6ac0 <malloc+0x1754>
    30b6:	202020ef          	jal	52b8 <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	a2650513          	addi	a0,a0,-1498 # 6ae8 <malloc+0x177c>
    30ca:	1ee020ef          	jal	52b8 <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	a3250513          	addi	a0,a0,-1486 # 6b08 <malloc+0x179c>
    30de:	1da020ef          	jal	52b8 <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	a3e50513          	addi	a0,a0,-1474 # 6b28 <malloc+0x17bc>
    30f2:	1c6020ef          	jal	52b8 <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	a5250513          	addi	a0,a0,-1454 # 6b50 <malloc+0x17e4>
    3106:	1b2020ef          	jal	52b8 <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	a5e50513          	addi	a0,a0,-1442 # 6b70 <malloc+0x1804>
    311a:	19e020ef          	jal	52b8 <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	a6a50513          	addi	a0,a0,-1430 # 6b90 <malloc+0x1824>
    312e:	18a020ef          	jal	52b8 <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	a7e50513          	addi	a0,a0,-1410 # 6bb8 <malloc+0x184c>
    3142:	176020ef          	jal	52b8 <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	6fa50513          	addi	a0,a0,1786 # 6848 <malloc+0x14dc>
    3156:	162020ef          	jal	52b8 <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	a7650513          	addi	a0,a0,-1418 # 6bd8 <malloc+0x186c>
    316a:	14e020ef          	jal	52b8 <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	a8250513          	addi	a0,a0,-1406 # 6bf8 <malloc+0x188c>
    317e:	13a020ef          	jal	52b8 <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	a9e50513          	addi	a0,a0,-1378 # 6c28 <malloc+0x18bc>
    3192:	126020ef          	jal	52b8 <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	aaa50513          	addi	a0,a0,-1366 # 6c48 <malloc+0x18dc>
    31a6:	112020ef          	jal	52b8 <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	a3050513          	addi	a0,a0,-1488 # 6c68 <malloc+0x18fc>
    3240:	078020ef          	jal	52b8 <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	a3450513          	addi	a0,a0,-1484 # 6c80 <malloc+0x1914>
    3254:	064020ef          	jal	52b8 <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	a3850513          	addi	a0,a0,-1480 # 6c98 <malloc+0x192c>
    3268:	050020ef          	jal	52b8 <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	a3c50513          	addi	a0,a0,-1476 # 6cb0 <malloc+0x1944>
    327c:	03c020ef          	jal	52b8 <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	3d850513          	addi	a0,a0,984 # 6660 <malloc+0x12f4>
    3290:	028020ef          	jal	52b8 <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	a3450513          	addi	a0,a0,-1484 # 6cd0 <malloc+0x1964>
    32a4:	014020ef          	jal	52b8 <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	a4850513          	addi	a0,a0,-1464 # 6cf8 <malloc+0x198c>
    32b8:	000020ef          	jal	52b8 <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	a5450513          	addi	a0,a0,-1452 # 6d18 <malloc+0x19ac>
    32cc:	7ed010ef          	jal	52b8 <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	a5050513          	addi	a0,a0,-1456 # 6d38 <malloc+0x19cc>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	a3c50513          	addi	a0,a0,-1476 # 6d38 <malloc+0x19cc>
    3304:	371010ef          	jal	4e74 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	a7450513          	addi	a0,a0,-1420 # 6d80 <malloc+0x1a14>
  ...
  fd = open(".", 0);
    ...
    3390:	80450513          	addi	a0,a0,-2044 # 5b90 <malloc+0x824>
    3394:	2b1010ef          	jal	4e44 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	17c58593          	addi	a1,a1,380 # 5518 <malloc+0x1ac>
  ...
  close(fd);
    ...
    33c4:	98050513          	addi	a0,a0,-1664 # 6d40 <malloc+0x19d4>
    33c8:	6f1010ef          	jal	52b8 <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	98c50513          	addi	a0,a0,-1652 # 6d60 <malloc+0x19f4>
    33dc:	6dd010ef          	jal	52b8 <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	9a850513          	addi	a0,a0,-1624 # 6d90 <malloc+0x1a24>
    33f0:	6c9010ef          	jal	52b8 <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	99450513          	addi	a0,a0,-1644 # 6d90 <malloc+0x1a24>
    3404:	6b5010ef          	jal	52b8 <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	9a850513          	addi	a0,a0,-1624 # 6db8 <malloc+0x1a4c>
    3418:	6a1010ef          	jal	52b8 <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	9bc50513          	addi	a0,a0,-1604 # 6de0 <malloc+0x1a74>
    342c:	68d010ef          	jal	52b8 <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	9d050513          	addi	a0,a0,-1584 # 6e08 <malloc+0x1a9c>
    3440:	679010ef          	jal	52b8 <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	9e450513          	addi	a0,a0,-1564 # 6e30 <malloc+0x1ac4>
    3454:	665010ef          	jal	52b8 <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	9f050513          	addi	a0,a0,-1552 # 6e50 <malloc+0x1ae4>
    3468:	651010ef          	jal	52b8 <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	a0450513          	addi	a0,a0,-1532 # 6e78 <malloc+0x1b0c>
    347c:	63d010ef          	jal	52b8 <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	9f0a0a13          	addi	s4,s4,-1552 # 6e90 <malloc+0x1b24>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	4f048493          	addi	s1,s1,1264 # 6998 <malloc+0x162c>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	1d0a8a93          	addi	s5,s5,464 # 5680 <malloc+0x314>
    fd = open("xx", O_CREATE);
    34b8:	00004997          	auipc	s3,0x4
    34bc:	8d098993          	addi	s3,s3,-1840 # 6d88 <malloc+0x1a1c>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	9d450513          	addi	a0,a0,-1580 # 6e98 <malloc+0x1b2c>
    34cc:	5ed010ef          	jal	52b8 <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	9d850513          	addi	a0,a0,-1576 # 6eb0 <malloc+0x1b44>
    34e0:	5d9010ef          	jal	52b8 <printf>
      exit(1);
    34e4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	17098993          	addi	s3,s3,368 # 66b0 <malloc+0x1344>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	94890913          	addi	s2,s2,-1720 # 6e90 <malloc+0x1b24>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	0f850513          	addi	a0,a0,248 # 6658 <malloc+0x12ec>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	93c50513          	addi	a0,a0,-1732 # 6ec8 <malloc+0x1b5c>
  ...
  if(pid == 0){
    ...
    35ac:	92050513          	addi	a0,a0,-1760 # 6ec8 <malloc+0x1b5c>
    ...
    35be:	92e50513          	addi	a0,a0,-1746 # 6ee8 <malloc+0x1b7c>
    35c2:	4f7010ef          	jal	52b8 <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	90250513          	addi	a0,a0,-1790 # 6ed0 <malloc+0x1b64>
    35d6:	4e3010ef          	jal	52b8 <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	75650513          	addi	a0,a0,1878 # 5d38 <malloc+0x9cc>
    35ea:	4cf010ef          	jal	52b8 <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3604:	8c850513          	addi	a0,a0,-1848 # 6ec8 <malloc+0x1b5c>
    3608:	04d010ef          	jal	4e54 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00003517          	auipc	a0,0x3
    3614:	91850513          	addi	a0,a0,-1768 # 5f28 <malloc+0xbbc>
    3618:	4a1010ef          	jal	52b8 <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	8d250513          	addi	a0,a0,-1838 # 6f10 <malloc+0x1ba4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	8b250513          	addi	a0,a0,-1870 # 6f10 <malloc+0x1ba4>
  ...
  pause(10); // one second
    ...
    368a:	87250513          	addi	a0,a0,-1934 # 5ef8 <malloc+0xb8c>
    368e:	42b010ef          	jal	52b8 <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	770010ef          	jal	4e04 <exit>
      int fd = open("stopforking", 0);
    3698:	00004497          	auipc	s1,0x4
    369c:	87848493          	addi	s1,s1,-1928 # 6f10 <malloc+0x1ba4>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	85850513          	addi	a0,a0,-1960 # 6f10 <malloc+0x1ba4>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	61a50513          	addi	a0,a0,1562 # 5d38 <malloc+0x9cc>
    3726:	393010ef          	jal	52b8 <printf>
      exit(1);
    372a:	4505                	li	a0,1
    ...
    373c:	7e850513          	addi	a0,a0,2024 # 6f20 <malloc+0x1bb4>
    3740:	379010ef          	jal	52b8 <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	78c50513          	addi	a0,a0,1932 # 5ef8 <malloc+0xb8c>
    3774:	345010ef          	jal	52b8 <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	5aa50513          	addi	a0,a0,1450 # 5d38 <malloc+0x9cc>
    3796:	323010ef          	jal	52b8 <printf>
    exit(1);
    379a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37c2:	d5a58593          	addi	a1,a1,-678 # 5518 <malloc+0x1ac>
    ...
    37e4:	55850513          	addi	a0,a0,1368 # 5d38 <malloc+0x9cc>
    37e8:	2d1010ef          	jal	52b8 <printf>
     exit(1);
    37ec:	4505                	li	a0,1
    ...
    37f8:	74c50513          	addi	a0,a0,1868 # 6f40 <malloc+0x1bd4>
    37fc:	2bd010ef          	jal	52b8 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	73450513          	addi	a0,a0,1844 # 6f58 <malloc+0x1bec>
    382c:	28d010ef          	jal	52b8 <printf>
}
  ...
  printf("kill... ");
    ...
    384c:	72850513          	addi	a0,a0,1832 # 6f70 <malloc+0x1c04>
    3850:	269010ef          	jal	52b8 <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    386a:	71a50513          	addi	a0,a0,1818 # 6f80 <malloc+0x1c14>
    386e:	24b010ef          	jal	52b8 <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	47250513          	addi	a0,a0,1138 # 5d38 <malloc+0x9cc>
    38ce:	1eb010ef          	jal	52b8 <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	5e650513          	addi	a0,a0,1510 # 5ec0 <malloc+0xb54>
    38e2:	1d7010ef          	jal	52b8 <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	50250513          	addi	a0,a0,1282 # 5e40 <malloc+0xad4>
    3946:	173010ef          	jal	52b8 <printf>
    exit(1);
    394a:	4505                	li	a0,1
    ...
    396c:	da058593          	addi	a1,a1,-608 # 7708 <malloc+0x239c>
    ...
    3988:	60c58593          	addi	a1,a1,1548 # 6f90 <malloc+0x1c24>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	5c250513          	addi	a0,a0,1474 # 6f98 <malloc+0x1c2c>
    39de:	0db010ef          	jal	52b8 <printf>
  ...
  if(pid == 0){
    ...
    3a24:	5c850513          	addi	a0,a0,1480 # 6fe8 <malloc+0x1c7c>
    3a28:	091010ef          	jal	52b8 <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	59450513          	addi	a0,a0,1428 # 6fc8 <malloc+0x1c5c>
    3a3c:	07d010ef          	jal	52b8 <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	2f050513          	addi	a0,a0,752 # 5d38 <malloc+0x9cc>
    3a50:	069010ef          	jal	52b8 <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	01b010ef          	jal	52ea <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	095010ef          	jal	536c <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	00d010ef          	jal	52ea <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	52e50513          	addi	a0,a0,1326 # 7018 <malloc+0x1cac>
    3af2:	7c6010ef          	jal	52b8 <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	52a50513          	addi	a0,a0,1322 # 7038 <malloc+0x1ccc>
    3b16:	33e010ef          	jal	4e54 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	51a50513          	addi	a0,a0,1306 # 7038 <malloc+0x1ccc>
  ...
  if(pid == 0) {
    ...
    3b8c:	4c050513          	addi	a0,a0,1216 # 7048 <malloc+0x1cdc>
    3b90:	728010ef          	jal	52b8 <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	4d450513          	addi	a0,a0,1236 # 7070 <malloc+0x1d04>
    3ba4:	714010ef          	jal	52b8 <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	46c50513          	addi	a0,a0,1132 # 7038 <malloc+0x1ccc>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	48c50513          	addi	a0,a0,1164 # 7090 <malloc+0x1d24>
    3c0c:	6ac010ef          	jal	52b8 <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c38:	40450513          	addi	a0,a0,1028 # 7038 <malloc+0x1ccc>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	46250513          	addi	a0,a0,1122 # 70b8 <malloc+0x1d4c>
    3c5e:	65a010ef          	jal	52b8 <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	44278793          	addi	a5,a5,1090 # 70d0 <malloc+0x1d64>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	43e78793          	addi	a5,a5,1086 # 70d8 <malloc+0x1d6c>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	43a78793          	addi	a5,a5,1082 # 70e0 <malloc+0x1d74>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	43678793          	addi	a5,a5,1078 # 70e8 <malloc+0x1d7c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	02450513          	addi	a0,a0,36 # 5d38 <malloc+0x9cc>
    3d1c:	59c010ef          	jal	52b8 <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	05a50513          	addi	a0,a0,90 # 5dd0 <malloc+0xa64>
    3d7e:	53a010ef          	jal	52b8 <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	080010ef          	jal	4e04 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	36850513          	addi	a0,a0,872 # 70f0 <malloc+0x1d84>
    3d90:	528010ef          	jal	52b8 <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	36650513          	addi	a0,a0,870 # 7108 <malloc+0x1d9c>
    3daa:	50e010ef          	jal	52b8 <printf>
          exit(1);
    3dae:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	30650513          	addi	a0,a0,774 # 7118 <malloc+0x1dac>
    3e1a:	49e010ef          	jal	52b8 <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	2c4b8b93          	addi	s7,s7,708 # 7130 <malloc+0x1dc4>
  for(i = 0; i < N; i++){
    ...
    3eaa:	29250513          	addi	a0,a0,658 # 7138 <malloc+0x1dcc>
    3eae:	40a010ef          	jal	52b8 <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	27450513          	addi	a0,a0,628 # 7130 <malloc+0x1dc4>
  ...
  fd = open(".", 0);
    ...
    3ee8:	cac50513          	addi	a0,a0,-852 # 5b90 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	20450513          	addi	a0,a0,516 # 7158 <malloc+0x1dec>
    3f5c:	35c010ef          	jal	52b8 <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	20c50513          	addi	a0,a0,524 # 7178 <malloc+0x1e0c>
    3f74:	344010ef          	jal	52b8 <printf>
        exit(1);
    3f78:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	20850513          	addi	a0,a0,520 # 71a0 <malloc+0x1e34>
    3fa0:	318010ef          	jal	52b8 <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	d8c50513          	addi	a0,a0,-628 # 5d38 <malloc+0x9cc>
    3fb4:	304010ef          	jal	52b8 <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	0de50513          	addi	a0,a0,222 # 71d8 <malloc+0x1e6c>
    4102:	553000ef          	jal	4e54 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	0ce50513          	addi	a0,a0,206 # 71d8 <malloc+0x1e6c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	08250513          	addi	a0,a0,130 # 71d8 <malloc+0x1e6c>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	03650513          	addi	a0,a0,54 # 71e8 <malloc+0x1e7c>
    41ba:	0fe010ef          	jal	52b8 <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	04250513          	addi	a0,a0,66 # 7208 <malloc+0x1e9c>
    41ce:	0ea010ef          	jal	52b8 <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	04e50513          	addi	a0,a0,78 # 7228 <malloc+0x1ebc>
    41e2:	0d6010ef          	jal	52b8 <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	05a50513          	addi	a0,a0,90 # 7248 <malloc+0x1edc>
    41f6:	0c2010ef          	jal	52b8 <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	06650513          	addi	a0,a0,102 # 7268 <malloc+0x1efc>
    420a:	0ae010ef          	jal	52b8 <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	06a50513          	addi	a0,a0,106 # 7280 <malloc+0x1f14>
    421e:	09a010ef          	jal	52b8 <printf>
      exit(1);
    4222:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    423c:	fa050513          	addi	a0,a0,-96 # 71d8 <malloc+0x1e6c>
    ...
    425c:	04850513          	addi	a0,a0,72 # 72a0 <malloc+0x1f34>
    4260:	058010ef          	jal	52b8 <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	04a50513          	addi	a0,a0,74 # 72c0 <malloc+0x1f54>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	02450513          	addi	a0,a0,36 # 72c0 <malloc+0x1f54>
  ...
  close(fd);
    ...
    42fa:	1b250513          	addi	a0,a0,434 # 54a8 <malloc+0x13c>
    42fe:	33f000ef          	jal	4e3c <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	fba50513          	addi	a0,a0,-70 # 72c0 <malloc+0x1f54>
    ...
    4322:	fb250513          	addi	a0,a0,-78 # 72d0 <malloc+0x1f64>
    4326:	793000ef          	jal	52b8 <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	fba50513          	addi	a0,a0,-70 # 72f0 <malloc+0x1f84>
    433e:	77b000ef          	jal	52b8 <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	f8250513          	addi	a0,a0,-126 # 7310 <malloc+0x1fa4>
    4396:	723000ef          	jal	52b8 <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	269000ef          	jal	4e04 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	f8850513          	addi	a0,a0,-120 # 7328 <malloc+0x1fbc>
    43a8:	711000ef          	jal	52b8 <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	efa50513          	addi	a0,a0,-262 # 7310 <malloc+0x1fa4>
    441e:	69b000ef          	jal	52b8 <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	1e1000ef          	jal	4e04 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	f2850513          	addi	a0,a0,-216 # 7350 <malloc+0x1fe4>
    4430:	689000ef          	jal	52b8 <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	f1450513          	addi	a0,a0,-236 # 7360 <malloc+0x1ff4>
    4454:	665000ef          	jal	52b8 <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	ed650513          	addi	a0,a0,-298 # 7378 <malloc+0x200c>
    44aa:	60f000ef          	jal	52b8 <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	155000ef          	jal	4e04 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	53c78793          	addi	a5,a5,1340 # 79f0 <malloc+0x2684>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	198a0a13          	addi	s4,s4,408 # 5680 <malloc+0x314>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	0a0a8a93          	addi	s5,s5,160 # 5590 <malloc+0x224>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    4552:	e5a50513          	addi	a0,a0,-422 # 73a8 <malloc+0x203c>
    4556:	563000ef          	jal	52b8 <printf>
    455a:	4505                	li	a0,1
    455c:	0a9000ef          	jal	4e04 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	e6050513          	addi	a0,a0,-416 # 73c0 <malloc+0x2054>
    4568:	551000ef          	jal	52b8 <printf>
    456c:	4505                	li	a0,1
    456e:	097000ef          	jal	4e04 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	e5e50513          	addi	a0,a0,-418 # 73d0 <malloc+0x2064>
    457a:	53f000ef          	jal	52b8 <printf>
    457e:	4505                	li	a0,1
    4580:	085000ef          	jal	4e04 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	e6450513          	addi	a0,a0,-412 # 73e8 <malloc+0x207c>
    458c:	52d000ef          	jal	52b8 <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	e2050513          	addi	a0,a0,-480 # 7400 <malloc+0x2094>
    45e8:	4d1000ef          	jal	52b8 <printf>
    exit(1);
    45ec:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	e2850513          	addi	a0,a0,-472 # 7430 <malloc+0x20c4>
    4610:	4a9000ef          	jal	52b8 <printf>
    exit(1);
    4614:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    4632:	e3a50513          	addi	a0,a0,-454 # 7468 <malloc+0x20fc>
    4636:	483000ef          	jal	52b8 <printf>
    exit(1);
    463a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4652:	e4250513          	addi	a0,a0,-446 # 7490 <malloc+0x2124>
    4656:	463000ef          	jal	52b8 <printf>
    exit(1);
    465a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4672:	e4a50513          	addi	a0,a0,-438 # 74b8 <malloc+0x214c>
    4676:	443000ef          	jal	52b8 <printf>
    exit(1);
    467a:	4505                	li	a0,1
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	e4650513          	addi	a0,a0,-442 # 74e8 <malloc+0x217c>
    46aa:	40f000ef          	jal	52b8 <printf>
  for(nfiles = 0; ; nfiles++){
    46ae:	4481                	li	s1,0
    name[0] = 'f';
    ...
    46c2:	e3ac8c93          	addi	s9,s9,-454 # 74f8 <malloc+0x218c>
    name[0] = 'f';
    ...
    472a:	de250513          	addi	a0,a0,-542 # 7508 <malloc+0x219c>
    472e:	38b000ef          	jal	52b8 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4798:	d9450513          	addi	a0,a0,-620 # 7528 <malloc+0x21bc>
    479c:	31d000ef          	jal	52b8 <printf>
}
    ...
    47e6:	d3650513          	addi	a0,a0,-714 # 7518 <malloc+0x21ac>
    47ea:	2cf000ef          	jal	52b8 <printf>
    close(fd);
    47ee:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	d3450513          	addi	a0,a0,-716 # 7540 <malloc+0x21d4>
    4814:	2a5000ef          	jal	52b8 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4834:	d3850513          	addi	a0,a0,-712 # 7568 <malloc+0x21fc>
    4838:	281000ef          	jal	52b8 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4854:	d0050513          	addi	a0,a0,-768 # 7550 <malloc+0x21e4>
    4858:	261000ef          	jal	52b8 <printf>
    exit(1);
    485c:	4505                	li	a0,1
    ...
    4870:	d0450513          	addi	a0,a0,-764 # 7570 <malloc+0x2204>
    4874:	245000ef          	jal	52b8 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	cba50513          	addi	a0,a0,-838 # 7578 <malloc+0x220c>
    48c6:	1f3000ef          	jal	52b8 <printf>
          return -1;
    48ca:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	c3ac0c13          	addi	s8,s8,-966 # 7590 <malloc+0x2224>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	c38d8d93          	addi	s11,s11,-968 # 75a8 <malloc+0x223c>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	c50d0d13          	addi	s10,s10,-944 # 75c8 <malloc+0x225c>
    ...
    49f6:	c0650513          	addi	a0,a0,-1018 # 75f8 <malloc+0x228c>
    49fa:	0bf000ef          	jal	52b8 <printf>
      return 1;
    49fe:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	bb458593          	addi	a1,a1,-1100 # 7610 <malloc+0x22a4>
  ...
  int continuous = 0;
    ...
    4ab4:	b7050513          	addi	a0,a0,-1168 # 7620 <malloc+0x22b4>
    4ab8:	001000ef          	jal	52b8 <printf>
    exit(1);
    4abc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	b8250513          	addi	a0,a0,-1150 # 7650 <malloc+0x22e4>
    4ad6:	7e2000ef          	jal	52b8 <printf>
  exit(0);
    4ada:	4501                	li	a0,0
...
0000000000004ea4 <getppid>:
.global getppid
getppid:
 li a7, SYS_getppid
    4ea4:	02100893          	li	a7,33
 ecall
    4ea8:	00000073          	ecall
 ret
    4eac:	8082                	ret
...
ps:
 li a7, SYS_ps
    4eae:	02200893          	li	a7,34
 ecall
    4eb2:	00000073          	ecall
 ret
    4eb6:	8082                	ret

0000000000004eb8 <trace>:
.global trace
trace:
 li a7, SYS_trace
    4eb8:	02300893          	li	a7,35
 ecall
    4ebc:	00000073          	ecall
 ret
    4ec0:	8082                	ret

0000000000004ec2 <waitx>:
.global waitx
waitx:
 li a7, SYS_waitx
    4ec2:	02400893          	li	a7,36
 ecall
    4ec6:	00000073          	ecall
 ret
    4eca:	8082                	ret

0000000000004ecc <getcount>:
.global getcount
getcount:
 li a7, SYS_getcount
    4ecc:	02500893          	li	a7,37
 ecall
    4ed0:	00000073          	ecall
 ret
    4ed4:	8082                	ret

0000000000004ed6 <getcwd>:
.global getcwd
getcwd:
 li a7, SYS_getcwd
    4ed6:	48d9                	li	a7,22
...
0000000000004f0e <getprocessinfo>:
...
0000000000004f26 <shmdetach>:
.global shmdetach
shmdetach:
 li a7, SYS_shmdetach
    4f26:	02000893          	li	a7,32
 ecall
    4f2a:	00000073          	ecall
 ret
    4f2e:	8082                	ret

0000000000004f30 <putc>:
...
putc(int fd, char c)
{
    4f30:	1101                	addi	sp,sp,-32
    4f32:	ec06                	sd	ra,24(sp)
    4f34:	e822                	sd	s0,16(sp)
    4f36:	1000                	addi	s0,sp,32
    4f38:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4f3c:	4605                	li	a2,1
    4f3e:	fef40593          	addi	a1,s0,-17
    4f42:	ee3ff0ef          	jal	4e24 <write>
}
    4f46:	60e2                	ld	ra,24(sp)
    4f48:	6442                	ld	s0,16(sp)
    4f4a:	6105                	addi	sp,sp,32
    4f4c:	8082                	ret

0000000000004f4e <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4f4e:	715d                	addi	sp,sp,-80
    4f50:	e486                	sd	ra,72(sp)
    4f52:	e0a2                	sd	s0,64(sp)
    4f54:	f84a                	sd	s2,48(sp)
    4f56:	0880                	addi	s0,sp,80
    4f58:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4f5a:	c299                	beqz	a3,4f60 <printint+0x12>
    4f5c:	0805c363          	bltz	a1,4fe2 <printint+0x94>
  neg = 0;
    4f60:	4881                	li	a7,0
    4f62:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4f6c:	b3050513          	addi	a0,a0,-1232 # 7a98 <digits>
    4f70:	883e                	mv	a6,a5
    4f72:	2785                	addiw	a5,a5,1
    4f74:	02c5f733          	remu	a4,a1,a2
    4f78:	972a                	add	a4,a4,a0
    4f7a:	00074703          	lbu	a4,0(a4)
    4f7e:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4f82:	872e                	mv	a4,a1
    4f84:	02c5d5b3          	divu	a1,a1,a2
    4f88:	0685                	addi	a3,a3,1
    4f8a:	fec773e3          	bgeu	a4,a2,4f70 <printint+0x22>
  if(neg)
    4f8e:	00088b63          	beqz	a7,4fa4 <printint+0x56>
    buf[i++] = '-';
    4f92:	fd078793          	addi	a5,a5,-48
    4f96:	97a2                	add	a5,a5,s0
    4f98:	02d00713          	li	a4,45
    4f9c:	fee78423          	sb	a4,-24(a5)
    4fa0:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4fa4:	02f05a63          	blez	a5,4fd8 <printint+0x8a>
    4fa8:	fc26                	sd	s1,56(sp)
    4faa:	f44e                	sd	s3,40(sp)
    4fac:	fb840713          	addi	a4,s0,-72
    4fb0:	00f704b3          	add	s1,a4,a5
    4fb4:	fff70993          	addi	s3,a4,-1
    4fb8:	99be                	add	s3,s3,a5
    4fba:	37fd                	addiw	a5,a5,-1
    4fbc:	1782                	slli	a5,a5,0x20
    4fbe:	9381                	srli	a5,a5,0x20
    4fc0:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4fc4:	fff4c583          	lbu	a1,-1(s1)
    4fc8:	854a                	mv	a0,s2
    4fca:	f67ff0ef          	jal	4f30 <putc>
  while(--i >= 0)
    4fce:	14fd                	addi	s1,s1,-1
    4fd0:	ff349ae3          	bne	s1,s3,4fc4 <printint+0x76>
    4fd4:	74e2                	ld	s1,56(sp)
    4fd6:	79a2                	ld	s3,40(sp)
}
    4fd8:	60a6                	ld	ra,72(sp)
    4fda:	6406                	ld	s0,64(sp)
    4fdc:	7942                	ld	s2,48(sp)
    4fde:	6161                	addi	sp,sp,80
    4fe0:	8082                	ret
    x = -xx;
    4fe2:	40b005b3          	neg	a1,a1
    neg = 1;
    4fe6:	4885                	li	a7,1
    x = -xx;
    4fe8:	bfad                	j	4f62 <printint+0x14>

0000000000004fea <vprintf>:
}
...
{
    4fea:	711d                	addi	sp,sp,-96
    4fec:	ec86                	sd	ra,88(sp)
    4fee:	e8a2                	sd	s0,80(sp)
    4ff0:	e0ca                	sd	s2,64(sp)
    4ff2:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4ff4:	0005c903          	lbu	s2,0(a1)
    4ff8:	28090663          	beqz	s2,5284 <vprintf+0x29a>
    4ffc:	e4a6                	sd	s1,72(sp)
    4ffe:	fc4e                	sd	s3,56(sp)
    5000:	f852                	sd	s4,48(sp)
    5002:	f456                	sd	s5,40(sp)
    5004:	f05a                	sd	s6,32(sp)
    5006:	ec5e                	sd	s7,24(sp)
    5008:	e862                	sd	s8,16(sp)
    500a:	e466                	sd	s9,8(sp)
    500c:	8b2a                	mv	s6,a0
    500e:	8a2e                	mv	s4,a1
    5010:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5018:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    501c:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    5020:	06c00c93          	li	s9,108
    5024:	a005                	j	5044 <vprintf+0x5a>
        putc(fd, c0);
    5026:	85ca                	mv	a1,s2
    5028:	855a                	mv	a0,s6
    502a:	f07ff0ef          	jal	4f30 <putc>
    502e:	a019                	j	5034 <vprintf+0x4a>
    } else if(state == '%'){
    5030:	03598263          	beq	s3,s5,5054 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    5034:	2485                	addiw	s1,s1,1
    5036:	8726                	mv	a4,s1
    5038:	009a07b3          	add	a5,s4,s1
    503c:	0007c903          	lbu	s2,0(a5)
    5040:	22090a63          	beqz	s2,5274 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    5044:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5048:	fe0994e3          	bnez	s3,5030 <vprintf+0x46>
      if(c0 == '%'){
    504c:	fd579de3          	bne	a5,s5,5026 <vprintf+0x3c>
        state = '%';
    5050:	89be                	mv	s3,a5
    5052:	b7cd                	j	5034 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    5054:	00ea06b3          	add	a3,s4,a4
    5058:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    505c:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    505e:	c681                	beqz	a3,5066 <vprintf+0x7c>
    5060:	9752                	add	a4,a4,s4
    5062:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    5066:	05878363          	beq	a5,s8,50ac <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    506a:	05978d63          	beq	a5,s9,50c4 <vprintf+0xda>
    ...
    506e:	07500713          	li	a4,117
    5072:	0ee78763          	beq	a5,a4,5160 <vprintf+0x176>
    ...
    5076:	07800713          	li	a4,120
    507a:	12e78963          	beq	a5,a4,51ac <vprintf+0x1c2>
    ...
    507e:	07000713          	li	a4,112
    5082:	14e78e63          	beq	a5,a4,51de <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    5086:	06300713          	li	a4,99
    508a:	18e78e63          	beq	a5,a4,5226 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    508e:	07300713          	li	a4,115
    5092:	1ae78463          	beq	a5,a4,523a <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    5096:	02500713          	li	a4,37
    509a:	04e79563          	bne	a5,a4,50e4 <vprintf+0xfa>
        putc(fd, '%');
    509e:	02500593          	li	a1,37
    50a2:	855a                	mv	a0,s6
    50a4:	e8dff0ef          	jal	4f30 <putc>
      ...
      state = 0;
    50a8:	4981                	li	s3,0
    50aa:	b769                	j	5034 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    50ac:	008b8913          	addi	s2,s7,8
    50b0:	4685                	li	a3,1
    50b2:	4629                	li	a2,10
    50b4:	000ba583          	lw	a1,0(s7)
    50b8:	855a                	mv	a0,s6
    50ba:	e95ff0ef          	jal	4f4e <printint>
    50be:	8bca                	mv	s7,s2
      state = 0;
    50c0:	4981                	li	s3,0
    50c2:	bf8d                	j	5034 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    50c4:	06400793          	li	a5,100
    50c8:	02f68963          	beq	a3,a5,50fa <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    50cc:	06c00793          	li	a5,108
    50d0:	04f68263          	beq	a3,a5,5114 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    50d4:	07500793          	li	a5,117
    50d8:	0af68063          	beq	a3,a5,5178 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    50dc:	07800793          	li	a5,120
    50e0:	0ef68263          	beq	a3,a5,51c4 <vprintf+0x1da>
        putc(fd, '%');
    50e4:	02500593          	li	a1,37
    50e8:	855a                	mv	a0,s6
    50ea:	e47ff0ef          	jal	4f30 <putc>
        putc(fd, c0);
    50ee:	85ca                	mv	a1,s2
    50f0:	855a                	mv	a0,s6
    50f2:	e3fff0ef          	jal	4f30 <putc>
      state = 0;
    50f6:	4981                	li	s3,0
    50f8:	bf35                	j	5034 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    5106:	855a                	mv	a0,s6
    5108:	e47ff0ef          	jal	4f4e <printint>
        i += 1;
    510c:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    510e:	8bca                	mv	s7,s2
      state = 0;
    5110:	4981                	li	s3,0
        i += 1;
    5112:	b70d                	j	5034 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5114:	06400793          	li	a5,100
    5118:	02f60763          	beq	a2,a5,5146 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    511c:	07500793          	li	a5,117
    5120:	06f60963          	beq	a2,a5,5192 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    5124:	07800793          	li	a5,120
    5128:	faf61ee3          	bne	a2,a5,50e4 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    5138:	855a                	mv	a0,s6
    513a:	e15ff0ef          	jal	4f4e <printint>
        i += 2;
    513e:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    5140:	8bca                	mv	s7,s2
      state = 0;
    5142:	4981                	li	s3,0
        i += 2;
    5144:	bdc5                	j	5034 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    5152:	855a                	mv	a0,s6
    5154:	dfbff0ef          	jal	4f4e <printint>
        i += 2;
    ...
    516c:	855a                	mv	a0,s6
    516e:	de1ff0ef          	jal	4f4e <printint>
    5172:	8bca                	mv	s7,s2
      state = 0;
    5174:	4981                	li	s3,0
    5176:	bd7d                	j	5034 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5184:	855a                	mv	a0,s6
    5186:	dc9ff0ef          	jal	4f4e <printint>
        i += 1;
    ...
    519e:	855a                	mv	a0,s6
    51a0:	dafff0ef          	jal	4f4e <printint>
        i += 2;
    51a4:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    51a6:	8bca                	mv	s7,s2
      state = 0;
    51a8:	4981                	li	s3,0
        i += 2;
    51aa:	b569                	j	5034 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    51ac:	008b8913          	addi	s2,s7,8
    51b0:	4681                	li	a3,0
    51b2:	4641                	li	a2,16
    51b4:	000be583          	lwu	a1,0(s7)
    51b8:	855a                	mv	a0,s6
    51ba:	d95ff0ef          	jal	4f4e <printint>
    51be:	8bca                	mv	s7,s2
      state = 0;
    51c0:	4981                	li	s3,0
    51c2:	bd8d                	j	5034 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    51c4:	008b8913          	addi	s2,s7,8
    51c8:	4681                	li	a3,0
    51ca:	4641                	li	a2,16
    51cc:	000bb583          	ld	a1,0(s7)
    51d0:	855a                	mv	a0,s6
    51d2:	d7dff0ef          	jal	4f4e <printint>
        i += 1;
    ...
    51da:	4981                	li	s3,0
        i += 1;
    51dc:	bda1                	j	5034 <vprintf+0x4a>
    51de:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    51e0:	008b8d13          	addi	s10,s7,8
    51e4:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    51e8:	03000593          	li	a1,48
    51ec:	855a                	mv	a0,s6
    51ee:	d43ff0ef          	jal	4f30 <putc>
  putc(fd, 'x');
    51f2:	07800593          	li	a1,120
    51f6:	855a                	mv	a0,s6
    51f8:	d39ff0ef          	jal	4f30 <putc>
    51fc:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    51fe:	00003b97          	auipc	s7,0x3
    5202:	89ab8b93          	addi	s7,s7,-1894 # 7a98 <digits>
    5206:	03c9d793          	srli	a5,s3,0x3c
    520a:	97de                	add	a5,a5,s7
    520c:	0007c583          	lbu	a1,0(a5)
    5210:	855a                	mv	a0,s6
    5212:	d1fff0ef          	jal	4f30 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5216:	0992                	slli	s3,s3,0x4
    5218:	397d                	addiw	s2,s2,-1
    521a:	fe0916e3          	bnez	s2,5206 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    521e:	8bea                	mv	s7,s10
      state = 0;
    5220:	4981                	li	s3,0
    5222:	6d02                	ld	s10,0(sp)
    5224:	bd01                	j	5034 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    5226:	008b8913          	addi	s2,s7,8
    522a:	000bc583          	lbu	a1,0(s7)
    522e:	855a                	mv	a0,s6
    5230:	d01ff0ef          	jal	4f30 <putc>
    5234:	8bca                	mv	s7,s2
      state = 0;
    5236:	4981                	li	s3,0
    5238:	bbf5                	j	5034 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    523a:	008b8993          	addi	s3,s7,8
    523e:	000bb903          	ld	s2,0(s7)
    5242:	00090f63          	beqz	s2,5260 <vprintf+0x276>
        for(; *s; s++)
    5246:	00094583          	lbu	a1,0(s2)
    524a:	c195                	beqz	a1,526e <vprintf+0x284>
          putc(fd, *s);
    524c:	855a                	mv	a0,s6
    524e:	ce3ff0ef          	jal	4f30 <putc>
        for(; *s; s++)
    5252:	0905                	addi	s2,s2,1
    5254:	00094583          	lbu	a1,0(s2)
    5258:	f9f5                	bnez	a1,524c <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    525a:	8bce                	mv	s7,s3
      state = 0;
    525c:	4981                	li	s3,0
    525e:	bbd9                	j	5034 <vprintf+0x4a>
          s = "(null)";
    5260:	00002917          	auipc	s2,0x2
    5264:	78890913          	addi	s2,s2,1928 # 79e8 <malloc+0x267c>
        for(; *s; s++)
    5268:	02800593          	li	a1,40
    526c:	b7c5                	j	524c <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    526e:	8bce                	mv	s7,s3
      state = 0;
    5270:	4981                	li	s3,0
    5272:	b3c9                	j	5034 <vprintf+0x4a>
    5274:	64a6                	ld	s1,72(sp)
    5276:	79e2                	ld	s3,56(sp)
    5278:	7a42                	ld	s4,48(sp)
    527a:	7aa2                	ld	s5,40(sp)
    527c:	7b02                	ld	s6,32(sp)
    527e:	6be2                	ld	s7,24(sp)
    5280:	6c42                	ld	s8,16(sp)
    5282:	6ca2                	ld	s9,8(sp)
    }
  }
}
    5284:	60e6                	ld	ra,88(sp)
    5286:	6446                	ld	s0,80(sp)
    5288:	6906                	ld	s2,64(sp)
    528a:	6125                	addi	sp,sp,96
    528c:	8082                	ret

000000000000528e <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    528e:	715d                	addi	sp,sp,-80
    5290:	ec06                	sd	ra,24(sp)
    5292:	e822                	sd	s0,16(sp)
    5294:	1000                	addi	s0,sp,32
    5296:	e010                	sd	a2,0(s0)
    5298:	e414                	sd	a3,8(s0)
    529a:	e818                	sd	a4,16(s0)
    529c:	ec1c                	sd	a5,24(s0)
    529e:	03043023          	sd	a6,32(s0)
    52a2:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    52a6:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    52aa:	8622                	mv	a2,s0
    52ac:	d3fff0ef          	jal	4fea <vprintf>
}
    52b0:	60e2                	ld	ra,24(sp)
    52b2:	6442                	ld	s0,16(sp)
    52b4:	6161                	addi	sp,sp,80
    52b6:	8082                	ret

00000000000052b8 <printf>:

void
printf(const char *fmt, ...)
{
    52b8:	711d                	addi	sp,sp,-96
    52ba:	ec06                	sd	ra,24(sp)
    52bc:	e822                	sd	s0,16(sp)
    52be:	1000                	addi	s0,sp,32
    52c0:	e40c                	sd	a1,8(s0)
    52c2:	e810                	sd	a2,16(s0)
    52c4:	ec14                	sd	a3,24(s0)
    52c6:	f018                	sd	a4,32(s0)
    52c8:	f41c                	sd	a5,40(s0)
    52ca:	03043823          	sd	a6,48(s0)
    52ce:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    52d2:	00840613          	addi	a2,s0,8
    52d6:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    52da:	85aa                	mv	a1,a0
    52dc:	4505                	li	a0,1
    52de:	d0dff0ef          	jal	4fea <vprintf>
}
    52e2:	60e2                	ld	ra,24(sp)
    52e4:	6442                	ld	s0,16(sp)
    52e6:	6125                	addi	sp,sp,96
    52e8:	8082                	ret

00000000000052ea <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    52ea:	1141                	addi	sp,sp,-16
    52ec:	e422                	sd	s0,8(sp)
    52ee:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    52f0:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    52f4:	00003797          	auipc	a5,0x3
    52f8:	19c7b783          	ld	a5,412(a5) # 8490 <freep>
    52fc:	a02d                	j	5326 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    52fe:	4618                	lw	a4,8(a2)
    5300:	9f2d                	addw	a4,a4,a1
    5302:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5306:	6398                	ld	a4,0(a5)
    5308:	6310                	ld	a2,0(a4)
    530a:	a83d                	j	5348 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    530c:	ff852703          	lw	a4,-8(a0)
    5310:	9f31                	addw	a4,a4,a2
    5312:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5314:	ff053683          	ld	a3,-16(a0)
    5318:	a091                	j	535c <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    531a:	6398                	ld	a4,0(a5)
    531c:	00e7e463          	bltu	a5,a4,5324 <free+0x3a>
    5320:	00e6ea63          	bltu	a3,a4,5334 <free+0x4a>
{
    5324:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5326:	fed7fae3          	bgeu	a5,a3,531a <free+0x30>
    532a:	6398                	ld	a4,0(a5)
    532c:	00e6e463          	bltu	a3,a4,5334 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5330:	fee7eae3          	bltu	a5,a4,5324 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5334:	ff852583          	lw	a1,-8(a0)
    5338:	6390                	ld	a2,0(a5)
    533a:	02059813          	slli	a6,a1,0x20
    533e:	01c85713          	srli	a4,a6,0x1c
    5342:	9736                	add	a4,a4,a3
    5344:	fae60de3          	beq	a2,a4,52fe <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5348:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    534c:	4790                	lw	a2,8(a5)
    534e:	02061593          	slli	a1,a2,0x20
    5352:	01c5d713          	srli	a4,a1,0x1c
    5356:	973e                	add	a4,a4,a5
    5358:	fae68ae3          	beq	a3,a4,530c <free+0x22>
    p->s.ptr = bp->s.ptr;
    535c:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    535e:	00003717          	auipc	a4,0x3
    5362:	12f73923          	sd	a5,306(a4) # 8490 <freep>
}
    5366:	6422                	ld	s0,8(sp)
    5368:	0141                	addi	sp,sp,16
    536a:	8082                	ret

000000000000536c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    536c:	7139                	addi	sp,sp,-64
    536e:	fc06                	sd	ra,56(sp)
    5370:	f822                	sd	s0,48(sp)
    5372:	f426                	sd	s1,40(sp)
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5378:	02051493          	slli	s1,a0,0x20
    537c:	9081                	srli	s1,s1,0x20
    537e:	04bd                	addi	s1,s1,15
    5380:	8091                	srli	s1,s1,0x4
    5382:	0014899b          	addiw	s3,s1,1
    5386:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5388:	00003517          	auipc	a0,0x3
    538c:	10853503          	ld	a0,264(a0) # 8490 <freep>
    5390:	c915                	beqz	a0,53c4 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5392:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5394:	4798                	lw	a4,8(a5)
    5396:	08977a63          	bgeu	a4,s1,542a <malloc+0xbe>
    539a:	f04a                	sd	s2,32(sp)
    539c:	e852                	sd	s4,16(sp)
    539e:	e456                	sd	s5,8(sp)
    53a0:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    53a2:	8a4e                	mv	s4,s3
    53a4:	0009871b          	sext.w	a4,s3
    53a8:	6685                	lui	a3,0x1
    53aa:	00d77363          	bgeu	a4,a3,53b0 <malloc+0x44>
    53ae:	6a05                	lui	s4,0x1
    53b0:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    53b4:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    53b8:	00003917          	auipc	s2,0x3
    53bc:	0d890913          	addi	s2,s2,216 # 8490 <freep>
  if(p == SBRK_ERROR)
    53c0:	5afd                	li	s5,-1
    53c2:	a081                	j	5402 <malloc+0x96>
    53c4:	f04a                	sd	s2,32(sp)
    53c6:	e852                	sd	s4,16(sp)
    53c8:	e456                	sd	s5,8(sp)
    53ca:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    53cc:	0000a797          	auipc	a5,0xa
    53d0:	8ec78793          	addi	a5,a5,-1812 # ecb8 <base>
    53d4:	00003717          	auipc	a4,0x3
    53d8:	0af73e23          	sd	a5,188(a4) # 8490 <freep>
    53dc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    53de:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    53e2:	b7c1                	j	53a2 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    53e4:	6398                	ld	a4,0(a5)
    53e6:	e118                	sd	a4,0(a0)
    53e8:	a8a9                	j	5442 <malloc+0xd6>
  hp->s.size = nu;
    53ea:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    53ee:	0541                	addi	a0,a0,16
    53f0:	efbff0ef          	jal	52ea <free>
  return freep;
    53f4:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    53f8:	c12d                	beqz	a0,545a <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    53fa:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    53fc:	4798                	lw	a4,8(a5)
    53fe:	02977263          	bgeu	a4,s1,5422 <malloc+0xb6>
    if(p == freep)
    5402:	00093703          	ld	a4,0(s2)
    5406:	853e                	mv	a0,a5
    5408:	fef719e3          	bne	a4,a5,53fa <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    540c:	8552                	mv	a0,s4
    540e:	933ff0ef          	jal	4d40 <sbrk>
  if(p == SBRK_ERROR)
    5412:	fd551ce3          	bne	a0,s5,53ea <malloc+0x7e>
        return 0;
    5416:	4501                	li	a0,0
    5418:	7902                	ld	s2,32(sp)
    541a:	6a42                	ld	s4,16(sp)
    541c:	6aa2                	ld	s5,8(sp)
    541e:	6b02                	ld	s6,0(sp)
    5420:	a03d                	j	544e <malloc+0xe2>
    5422:	7902                	ld	s2,32(sp)
    5424:	6a42                	ld	s4,16(sp)
    5426:	6aa2                	ld	s5,8(sp)
    5428:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    542a:	fae48de3          	beq	s1,a4,53e4 <malloc+0x78>
        p->s.size -= nunits;
    542e:	4137073b          	subw	a4,a4,s3
    5432:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5434:	02071693          	slli	a3,a4,0x20
    5438:	01c6d713          	srli	a4,a3,0x1c
    543c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    543e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5442:	00003717          	auipc	a4,0x3
    5446:	04a73723          	sd	a0,78(a4) # 8490 <freep>
      return (void*)(p + 1);
    544a:	01078513          	addi	a0,a5,16
  }
}
    544e:	70e2                	ld	ra,56(sp)
    5450:	7442                	ld	s0,48(sp)
    5452:	74a2                	ld	s1,40(sp)
    5454:	69e2                	ld	s3,24(sp)
    5456:	6121                	addi	sp,sp,64
    5458:	8082                	ret
    545a:	7902                	ld	s2,32(sp)
    545c:	6a42                	ld	s4,16(sp)
    545e:	6aa2                	ld	s5,8(sp)
    5460:	6b02                	ld	s6,0(sp)
    5462:	b7f5                	j	544e <malloc+0xe2>
