...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	1e650513          	addi	a0,a0,486 # 1270 <malloc+0x106>
      92:	3d9000ef          	jal	c6a <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	1da50513          	addi	a0,a0,474 # 1270 <malloc+0x106>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b0:	1cc50513          	addi	a0,a0,460 # 1278 <malloc+0x10e>
      b4:	002010ef          	jal	10b6 <printf>
    exit(1);
      b8:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      ca:	1da50513          	addi	a0,a0,474 # 12a0 <malloc+0x136>
      ce:	3a5000ef          	jal	c72 <chdir>
      d2:	00001997          	auipc	s3,0x1
      d6:	1de98993          	addi	s3,s3,478 # 12b0 <malloc+0x146>
      da:	c489                	beqz	s1,e4 <go+0x70>
      dc:	00001997          	auipc	s3,0x1
      e0:	1cc98993          	addi	s3,s3,460 # 12a8 <malloc+0x13e>
  uint64 iters = 0;
      e4:	4481                	li	s1,0
  int fd = -1;
      e6:	5a7d                	li	s4,-1
      e8:	00001917          	auipc	s2,0x1
      ec:	49890913          	addi	s2,s2,1176 # 1580 <malloc+0x416>
    ...
    if(what == 1){
      ...
      fa:	1c250513          	addi	a0,a0,450 # 12b8 <malloc+0x14e>
    ...
    int what = rand() % 23;
     ...
     148:	18450513          	addi	a0,a0,388 # 12c8 <malloc+0x15e>
     ...
     15a:	16250513          	addi	a0,a0,354 # 12b8 <malloc+0x14e>
     15e:	2f5000ef          	jal	c52 <unlink>
     162:	b755                	j	106 <go+0x92>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     164:	00001517          	auipc	a0,0x1
     168:	10c50513          	addi	a0,a0,268 # 1270 <malloc+0x106>
     ...
     176:	16e50513          	addi	a0,a0,366 # 12e0 <malloc+0x176>
     17a:	2d9000ef          	jal	c52 <unlink>
      chdir("/");
     17e:	00001517          	auipc	a0,0x1
     182:	12250513          	addi	a0,a0,290 # 12a0 <malloc+0x136>
     186:	2ed000ef          	jal	c72 <chdir>
     18a:	bfb5                	j	106 <go+0x92>
        printf("grind: chdir grindir failed\n");
     18c:	00001517          	auipc	a0,0x1
     190:	0ec50513          	addi	a0,a0,236 # 1278 <malloc+0x10e>
     194:	723000ef          	jal	10b6 <printf>
        exit(1);
     198:	4505                	li	a0,1
     ...
     1ac:	14050513          	addi	a0,a0,320 # 12e8 <malloc+0x17e>
     ...
     1c6:	13650513          	addi	a0,a0,310 # 12f8 <malloc+0x18e>
     ...
     2b4:	0d050513          	addi	a0,a0,208 # 1380 <malloc+0x216>
     2b8:	5ff000ef          	jal	10b6 <printf>
        exit(1);
     2bc:	4505                	li	a0,1
     ...
     2e6:	09e50513          	addi	a0,a0,158 # 1380 <malloc+0x216>
     2ea:	5cd000ef          	jal	10b6 <printf>
        exit(1);
     2ee:	4505                	li	a0,1
     2f0:	113000ef          	jal	c02 <exit>
      ...
      sbrk(6011);
     2f4:	6505                	lui	a0,0x1
     2f6:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x19b>
     ...
     32a:	07a50513          	addi	a0,a0,122 # 13a0 <malloc+0x236>
     ...
     34a:	05250513          	addi	a0,a0,82 # 1398 <malloc+0x22e>
     ...
     360:	02450513          	addi	a0,a0,36 # 1380 <malloc+0x216>
     364:	553000ef          	jal	10b6 <printf>
        exit(1);
     368:	4505                	li	a0,1
     36a:	099000ef          	jal	c02 <exit>
        printf("grind: chdir failed\n");
     36e:	00001517          	auipc	a0,0x1
     372:	04250513          	addi	a0,a0,66 # 13b0 <malloc+0x246>
     376:	541000ef          	jal	10b6 <printf>
        exit(1);
     37a:	4505                	li	a0,1
     ...
     3a4:	fe050513          	addi	a0,a0,-32 # 1380 <malloc+0x216>
     3a8:	50f000ef          	jal	10b6 <printf>
        exit(1);
     3ac:	4505                	li	a0,1
     ...
     3e4:	fe850513          	addi	a0,a0,-24 # 13c8 <malloc+0x25e>
     3e8:	4cf000ef          	jal	10b6 <printf>
        exit(1);
     3ec:	4505                	li	a0,1
     ...
     400:	fe458593          	addi	a1,a1,-28 # 13e0 <malloc+0x276>
     ...
     430:	fbc50513          	addi	a0,a0,-68 # 13e8 <malloc+0x27e>
     434:	483000ef          	jal	10b6 <printf>
     438:	bfe9                	j	412 <go+0x39e>
          printf("grind: pipe read failed\n");
     43a:	00001517          	auipc	a0,0x1
     43e:	fce50513          	addi	a0,a0,-50 # 1408 <malloc+0x29e>
     442:	475000ef          	jal	10b6 <printf>
     446:	b7c5                	j	426 <go+0x3b2>
        printf("grind: fork failed\n");
     448:	00001517          	auipc	a0,0x1
     44c:	f3850513          	addi	a0,a0,-200 # 1380 <malloc+0x216>
     450:	467000ef          	jal	10b6 <printf>
        exit(1);
     454:	4505                	li	a0,1
     ...
     4c2:	ec250513          	addi	a0,a0,-318 # 1380 <malloc+0x216>
     4c6:	3f1000ef          	jal	10b6 <printf>
        exit(1);
     4ca:	4505                	li	a0,1
     ...
     4d4:	f6050513          	addi	a0,a0,-160 # 1430 <malloc+0x2c6>
     ...
     4e4:	f5050513          	addi	a0,a0,-176 # 1430 <malloc+0x2c6>
     ...
     4f8:	eec58593          	addi	a1,a1,-276 # 13e0 <malloc+0x276>
     ...
     532:	f0250513          	addi	a0,a0,-254 # 1430 <malloc+0x2c6>
     536:	71c000ef          	jal	c52 <unlink>
     53a:	b6f1                	j	106 <go+0x92>
        printf("grind: create c failed\n");
     53c:	00001517          	auipc	a0,0x1
     540:	efc50513          	addi	a0,a0,-260 # 1438 <malloc+0x2ce>
     544:	373000ef          	jal	10b6 <printf>
        exit(1);
     548:	4505                	li	a0,1
     54a:	6b8000ef          	jal	c02 <exit>
        printf("grind: write c failed\n");
     54e:	00001517          	auipc	a0,0x1
     552:	f0250513          	addi	a0,a0,-254 # 1450 <malloc+0x2e6>
     556:	361000ef          	jal	10b6 <printf>
        exit(1);
     55a:	4505                	li	a0,1
     55c:	6a6000ef          	jal	c02 <exit>
        printf("grind: fstat failed\n");
     560:	00001517          	auipc	a0,0x1
     564:	f0850513          	addi	a0,a0,-248 # 1468 <malloc+0x2fe>
     568:	34f000ef          	jal	10b6 <printf>
        exit(1);
     56c:	4505                	li	a0,1
     ...
     578:	f0c50513          	addi	a0,a0,-244 # 1480 <malloc+0x316>
     57c:	33b000ef          	jal	10b6 <printf>
        exit(1);
     580:	4505                	li	a0,1
     582:	680000ef          	jal	c02 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     586:	00001517          	auipc	a0,0x1
     58a:	f2250513          	addi	a0,a0,-222 # 14a8 <malloc+0x33e>
     58e:	329000ef          	jal	10b6 <printf>
        exit(1);
     592:	4505                	li	a0,1
     ...
     636:	f1658593          	addi	a1,a1,-234 # 1548 <malloc+0x3de>
     ...
     656:	efe50513          	addi	a0,a0,-258 # 1550 <malloc+0x3e6>
     65a:	25d000ef          	jal	10b6 <printf>
        exit(1);
     65e:	4505                	li	a0,1
     660:	5a2000ef          	jal	c02 <exit>
        fprintf(2, "grind: pipe failed\n");
     664:	00001597          	auipc	a1,0x1
     668:	d6458593          	addi	a1,a1,-668 # 13c8 <malloc+0x25e>
     66c:	4509                	li	a0,2
     66e:	21f000ef          	jal	108c <fprintf>
        exit(1);
     672:	4505                	li	a0,1
     674:	58e000ef          	jal	c02 <exit>
        fprintf(2, "grind: pipe failed\n");
     678:	00001597          	auipc	a1,0x1
     67c:	d5058593          	addi	a1,a1,-688 # 13c8 <malloc+0x25e>
     680:	4509                	li	a0,2
     682:	20b000ef          	jal	108c <fprintf>
        exit(1);
     686:	4505                	li	a0,1
     ...
     6bc:	e1858593          	addi	a1,a1,-488 # 14d0 <malloc+0x366>
     6c0:	4509                	li	a0,2
     6c2:	1cb000ef          	jal	108c <fprintf>
          exit(1);
     6c6:	4505                	li	a0,1
     ...
     6d8:	e1478793          	addi	a5,a5,-492 # 14e8 <malloc+0x37e>
     6dc:	faf43423          	sd	a5,-88(s0)
     6e0:	00001797          	auipc	a5,0x1
     6e4:	e1078793          	addi	a5,a5,-496 # 14f0 <malloc+0x386>
     6e8:	faf43823          	sd	a5,-80(s0)
     6ec:	fa043c23          	sd	zero,-72(s0)
        exec("grindir/../echo", args);
     6f0:	fa840593          	addi	a1,s0,-88
     6f4:	00001517          	auipc	a0,0x1
     6f8:	e0450513          	addi	a0,a0,-508 # 14f8 <malloc+0x38e>
     6fc:	53e000ef          	jal	c3a <exec>
        fprintf(2, "grind: echo: not found\n");
     700:	00001597          	auipc	a1,0x1
     704:	e0858593          	addi	a1,a1,-504 # 1508 <malloc+0x39e>
     708:	4509                	li	a0,2
     70a:	183000ef          	jal	108c <fprintf>
        exit(2);
     70e:	4509                	li	a0,2
     710:	4f2000ef          	jal	c02 <exit>
        fprintf(2, "grind: fork failed\n");
     714:	00001597          	auipc	a1,0x1
     718:	c6c58593          	addi	a1,a1,-916 # 1380 <malloc+0x216>
     71c:	4509                	li	a0,2
     71e:	16f000ef          	jal	108c <fprintf>
        exit(3);
     722:	450d                	li	a0,3
     ...
     74c:	d8858593          	addi	a1,a1,-632 # 14d0 <malloc+0x366>
     750:	4509                	li	a0,2
     752:	13b000ef          	jal	108c <fprintf>
          exit(4);
     756:	4511                	li	a0,4
     ...
     77c:	d5858593          	addi	a1,a1,-680 # 14d0 <malloc+0x366>
     780:	4509                	li	a0,2
     782:	10b000ef          	jal	108c <fprintf>
          exit(5);
     786:	4515                	li	a0,5
     ...
     798:	d8c78793          	addi	a5,a5,-628 # 1520 <malloc+0x3b6>
     79c:	faf43423          	sd	a5,-88(s0)
     7a0:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     7a4:	fa840593          	addi	a1,s0,-88
     7a8:	00001517          	auipc	a0,0x1
     7ac:	d8050513          	addi	a0,a0,-640 # 1528 <malloc+0x3be>
     7b0:	48a000ef          	jal	c3a <exec>
        fprintf(2, "grind: cat: not found\n");
     7b4:	00001597          	auipc	a1,0x1
     7b8:	d7c58593          	addi	a1,a1,-644 # 1530 <malloc+0x3c6>
     7bc:	4509                	li	a0,2
     7be:	0cf000ef          	jal	108c <fprintf>
        exit(6);
     7c2:	4519                	li	a0,6
     7c4:	43e000ef          	jal	c02 <exit>
        fprintf(2, "grind: fork failed\n");
     7c8:	00001597          	auipc	a1,0x1
     7cc:	bb858593          	addi	a1,a1,-1096 # 1380 <malloc+0x216>
     7d0:	4509                	li	a0,2
     7d2:	0bb000ef          	jal	108c <fprintf>
        exit(7);
     7d6:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     7e8:	bb450513          	addi	a0,a0,-1100 # 1398 <malloc+0x22e>
     7ec:	466000ef          	jal	c52 <unlink>
  unlink("b");
     7f0:	00001517          	auipc	a0,0x1
     7f4:	b5850513          	addi	a0,a0,-1192 # 1348 <malloc+0x1de>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     82a:	b5a50513          	addi	a0,a0,-1190 # 1380 <malloc+0x216>
     82e:	089000ef          	jal	10b6 <printf>
    exit(1);
     832:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     84e:	629c                	ld	a5,0(a3)
     850:	6709                	lui	a4,0x2
     852:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x629>
    ...
    printf("grind: fork failed\n");
     ...
     864:	b2050513          	addi	a0,a0,-1248 # 1380 <malloc+0x216>
     868:	04f000ef          	jal	10b6 <printf>
    exit(1);
     86c:	4505                	li	a0,1
...
0000000000000ca2 <getppid>:
.global getppid
getppid:
 li a7, SYS_getppid
     ca2:	02100893          	li	a7,33
 ecall
     ca6:	00000073          	ecall
 ret
     caa:	8082                	ret
...
ps:
 li a7, SYS_ps
     cac:	02200893          	li	a7,34
 ecall
     cb0:	00000073          	ecall
 ret
     cb4:	8082                	ret

0000000000000cb6 <trace>:
.global trace
trace:
 li a7, SYS_trace
     cb6:	02300893          	li	a7,35
 ecall
     cba:	00000073          	ecall
 ret
     cbe:	8082                	ret

0000000000000cc0 <waitx>:
.global waitx
waitx:
 li a7, SYS_waitx
     cc0:	02400893          	li	a7,36
 ecall
     cc4:	00000073          	ecall
 ret
     cc8:	8082                	ret

0000000000000cca <getcount>:
.global getcount
getcount:
 li a7, SYS_getcount
     cca:	02500893          	li	a7,37
 ecall
     cce:	00000073          	ecall
 ret
     cd2:	8082                	ret

0000000000000cd4 <getcwd>:
.global getcwd
getcwd:
 li a7, SYS_getcwd
     cd4:	48d9                	li	a7,22
...
0000000000000d0c <getprocessinfo>:
...
0000000000000d24 <shmdetach>:
.global shmdetach
shmdetach:
 li a7, SYS_shmdetach
     d24:	02000893          	li	a7,32
 ecall
     d28:	00000073          	ecall
 ret
     d2c:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     d58:	c299                	beqz	a3,d5e <printint+0x12>
     d5a:	0805c363          	bltz	a1,de0 <printint+0x94>
  neg = 0;
     d5e:	4881                	li	a7,0
     d60:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d6a:	87a50513          	addi	a0,a0,-1926 # 15e0 <digits>
     d6e:	883e                	mv	a6,a5
     d70:	2785                	addiw	a5,a5,1
     d72:	02c5f733          	remu	a4,a1,a2
     d76:	972a                	add	a4,a4,a0
     d78:	00074703          	lbu	a4,0(a4)
     d7c:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     d80:	872e                	mv	a4,a1
     d82:	02c5d5b3          	divu	a1,a1,a2
     d86:	0685                	addi	a3,a3,1
     d88:	fec773e3          	bgeu	a4,a2,d6e <printint+0x22>
  if(neg)
     d8c:	00088b63          	beqz	a7,da2 <printint+0x56>
    buf[i++] = '-';
     d90:	fd078793          	addi	a5,a5,-48
     d94:	97a2                	add	a5,a5,s0
     d96:	02d00713          	li	a4,45
     d9a:	fee78423          	sb	a4,-24(a5)
     d9e:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     da2:	02f05a63          	blez	a5,dd6 <printint+0x8a>
     da6:	fc26                	sd	s1,56(sp)
     da8:	f44e                	sd	s3,40(sp)
     daa:	fb840713          	addi	a4,s0,-72
     dae:	00f704b3          	add	s1,a4,a5
     db2:	fff70993          	addi	s3,a4,-1
     db6:	99be                	add	s3,s3,a5
     db8:	37fd                	addiw	a5,a5,-1
     dba:	1782                	slli	a5,a5,0x20
     dbc:	9381                	srli	a5,a5,0x20
     dbe:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     dc2:	fff4c583          	lbu	a1,-1(s1)
     dc6:	854a                	mv	a0,s2
     dc8:	f67ff0ef          	jal	d2e <putc>
  while(--i >= 0)
     dcc:	14fd                	addi	s1,s1,-1
     dce:	ff349ae3          	bne	s1,s3,dc2 <printint+0x76>
     dd2:	74e2                	ld	s1,56(sp)
     dd4:	79a2                	ld	s3,40(sp)
}
     dd6:	60a6                	ld	ra,72(sp)
     dd8:	6406                	ld	s0,64(sp)
     dda:	7942                	ld	s2,48(sp)
     ddc:	6161                	addi	sp,sp,80
     dde:	8082                	ret
    x = -xx;
    ...
    neg = 1;
     de4:	4885                	li	a7,1
    x = -xx;
     de6:	bfad                	j	d60 <printint+0x14>

0000000000000de8 <vprintf>:
}
...
{
     de8:	711d                	addi	sp,sp,-96
     dea:	ec86                	sd	ra,88(sp)
     dec:	e8a2                	sd	s0,80(sp)
     dee:	e0ca                	sd	s2,64(sp)
     df0:	1080                	addi	s0,sp,96
  char *s;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     df6:	28090663          	beqz	s2,1082 <vprintf+0x29a>
     dfa:	e4a6                	sd	s1,72(sp)
     dfc:	fc4e                	sd	s3,56(sp)
     dfe:	f852                	sd	s4,48(sp)
     e00:	f456                	sd	s5,40(sp)
     e02:	f05a                	sd	s6,32(sp)
     e04:	ec5e                	sd	s7,24(sp)
     e06:	e862                	sd	s8,16(sp)
     e08:	e466                	sd	s9,8(sp)
     e0a:	8b2a                	mv	s6,a0
     e0c:	8a2e                	mv	s4,a1
     e0e:	8bb2                	mv	s7,a2
  ...
  for(i = 0; fmt[i]; i++){
     ...
     e1e:	06c00c93          	li	s9,108
     e22:	a005                	j	e42 <vprintf+0x5a>
        putc(fd, c0);
     e24:	85ca                	mv	a1,s2
     e26:	855a                	mv	a0,s6
     e28:	f07ff0ef          	jal	d2e <putc>
     e2c:	a019                	j	e32 <vprintf+0x4a>
    } else if(state == '%'){
     e2e:	03598263          	beq	s3,s5,e52 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     e32:	2485                	addiw	s1,s1,1
     e34:	8726                	mv	a4,s1
     e36:	009a07b3          	add	a5,s4,s1
     e3a:	0007c903          	lbu	s2,0(a5)
     e3e:	22090a63          	beqz	s2,1072 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
     e42:	0009079b          	sext.w	a5,s2
    if(state == 0){
     e46:	fe0994e3          	bnez	s3,e2e <vprintf+0x46>
      if(c0 == '%'){
     e4a:	fd579de3          	bne	a5,s5,e24 <vprintf+0x3c>
        state = '%';
     e4e:	89be                	mv	s3,a5
     e50:	b7cd                	j	e32 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     e52:	00ea06b3          	add	a3,s4,a4
     e56:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     e5a:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e5c:	c681                	beqz	a3,e64 <vprintf+0x7c>
     e5e:	9752                	add	a4,a4,s4
     e60:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e64:	05878363          	beq	a5,s8,eaa <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     e68:	05978d63          	beq	a5,s9,ec2 <vprintf+0xda>
     ...
     e6c:	07500713          	li	a4,117
     e70:	0ee78763          	beq	a5,a4,f5e <vprintf+0x176>
     ...
     e74:	07800713          	li	a4,120
     e78:	12e78963          	beq	a5,a4,faa <vprintf+0x1c2>
     ...
     e7c:	07000713          	li	a4,112
     e80:	14e78e63          	beq	a5,a4,fdc <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     e84:	06300713          	li	a4,99
     e88:	18e78e63          	beq	a5,a4,1024 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     e8c:	07300713          	li	a4,115
     e90:	1ae78463          	beq	a5,a4,1038 <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     e94:	02500713          	li	a4,37
     e98:	04e79563          	bne	a5,a4,ee2 <vprintf+0xfa>
        putc(fd, '%');
     e9c:	02500593          	li	a1,37
     ea0:	855a                	mv	a0,s6
     ea2:	e8dff0ef          	jal	d2e <putc>
     ...
     eb6:	855a                	mv	a0,s6
     eb8:	e95ff0ef          	jal	d4c <printint>
     ebc:	8bca                	mv	s7,s2
      state = 0;
     ebe:	4981                	li	s3,0
     ec0:	bf8d                	j	e32 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     ec2:	06400793          	li	a5,100
     ec6:	02f68963          	beq	a3,a5,ef8 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eca:	06c00793          	li	a5,108
     ece:	04f68263          	beq	a3,a5,f12 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     ed2:	07500793          	li	a5,117
     ed6:	0af68063          	beq	a3,a5,f76 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     eda:	07800793          	li	a5,120
     ede:	0ef68263          	beq	a3,a5,fc2 <vprintf+0x1da>
        putc(fd, '%');
     ee2:	02500593          	li	a1,37
     ee6:	855a                	mv	a0,s6
     ee8:	e47ff0ef          	jal	d2e <putc>
        putc(fd, c0);
     eec:	85ca                	mv	a1,s2
     eee:	855a                	mv	a0,s6
     ef0:	e3fff0ef          	jal	d2e <putc>
      state = 0;
     ef4:	4981                	li	s3,0
     ef6:	bf35                	j	e32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     f0e:	4981                	li	s3,0
        i += 1;
     f10:	b70d                	j	e32 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     f12:	06400793          	li	a5,100
     f16:	02f60763          	beq	a2,a5,f44 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     f1a:	07500793          	li	a5,117
     f1e:	06f60963          	beq	a2,a5,f90 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     f22:	07800793          	li	a5,120
     f26:	faf61ee3          	bne	a2,a5,ee2 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f6a:	855a                	mv	a0,s6
     f6c:	de1ff0ef          	jal	d4c <printint>
     f70:	8bca                	mv	s7,s2
      state = 0;
     f72:	4981                	li	s3,0
     f74:	bd7d                	j	e32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f9c:	855a                	mv	a0,s6
     f9e:	dafff0ef          	jal	d4c <printint>
        i += 2;
     fa2:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
     fa4:	8bca                	mv	s7,s2
      state = 0;
     fa6:	4981                	li	s3,0
        i += 2;
     fa8:	b569                	j	e32 <vprintf+0x4a>
     ...
     fb6:	855a                	mv	a0,s6
     fb8:	d95ff0ef          	jal	d4c <printint>
     fbc:	8bca                	mv	s7,s2
      state = 0;
     fbe:	4981                	li	s3,0
     fc0:	bd8d                	j	e32 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     fd8:	4981                	li	s3,0
        i += 1;
     fda:	bda1                	j	e32 <vprintf+0x4a>
     fdc:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
     fde:	008b8d13          	addi	s10,s7,8
     fe2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     fe6:	03000593          	li	a1,48
     fea:	855a                	mv	a0,s6
     fec:	d43ff0ef          	jal	d2e <putc>
  putc(fd, 'x');
     ff0:	07800593          	li	a1,120
     ff4:	855a                	mv	a0,s6
     ff6:	d39ff0ef          	jal	d2e <putc>
     ffa:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ffc:	00000b97          	auipc	s7,0x0
    1000:	5e4b8b93          	addi	s7,s7,1508 # 15e0 <digits>
    1004:	03c9d793          	srli	a5,s3,0x3c
    1008:	97de                	add	a5,a5,s7
    100a:	0007c583          	lbu	a1,0(a5)
    100e:	855a                	mv	a0,s6
    1010:	d1fff0ef          	jal	d2e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1014:	0992                	slli	s3,s3,0x4
    1016:	397d                	addiw	s2,s2,-1
    1018:	fe0916e3          	bnez	s2,1004 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    101c:	8bea                	mv	s7,s10
      state = 0;
    101e:	4981                	li	s3,0
    1020:	6d02                	ld	s10,0(sp)
    1022:	bd01                	j	e32 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    1024:	008b8913          	addi	s2,s7,8
    1028:	000bc583          	lbu	a1,0(s7)
    102c:	855a                	mv	a0,s6
    102e:	d01ff0ef          	jal	d2e <putc>
    1032:	8bca                	mv	s7,s2
      state = 0;
    1034:	4981                	li	s3,0
    1036:	bbf5                	j	e32 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    1038:	008b8993          	addi	s3,s7,8
    103c:	000bb903          	ld	s2,0(s7)
    1040:	00090f63          	beqz	s2,105e <vprintf+0x276>
        for(; *s; s++)
    1044:	00094583          	lbu	a1,0(s2)
    1048:	c195                	beqz	a1,106c <vprintf+0x284>
          putc(fd, *s);
    104a:	855a                	mv	a0,s6
    104c:	ce3ff0ef          	jal	d2e <putc>
        for(; *s; s++)
    1050:	0905                	addi	s2,s2,1
    1052:	00094583          	lbu	a1,0(s2)
    1056:	f9f5                	bnez	a1,104a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1058:	8bce                	mv	s7,s3
      state = 0;
    105a:	4981                	li	s3,0
    105c:	bbd9                	j	e32 <vprintf+0x4a>
          s = "(null)";
    105e:	00000917          	auipc	s2,0x0
    1062:	51a90913          	addi	s2,s2,1306 # 1578 <malloc+0x40e>
        for(; *s; s++)
    1066:	02800593          	li	a1,40
    106a:	b7c5                	j	104a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    106c:	8bce                	mv	s7,s3
      state = 0;
    106e:	4981                	li	s3,0
    1070:	b3c9                	j	e32 <vprintf+0x4a>
    ...
    1080:	6ca2                	ld	s9,8(sp)
    }
  }
}
    1082:	60e6                	ld	ra,88(sp)
    1084:	6446                	ld	s0,80(sp)
    1086:	6906                	ld	s2,64(sp)
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    10a8:	8622                	mv	a2,s0
    10aa:	d3fff0ef          	jal	de8 <vprintf>
}
    10ae:	60e2                	ld	ra,24(sp)
    10b0:	6442                	ld	s0,16(sp)
    10b2:	6161                	addi	sp,sp,80
    10b4:	8082                	ret
...
{
    10b6:	711d                	addi	sp,sp,-96
    10b8:	ec06                	sd	ra,24(sp)
    10ba:	e822                	sd	s0,16(sp)
    10bc:	1000                	addi	s0,sp,32
    10be:	e40c                	sd	a1,8(s0)
    10c0:	e810                	sd	a2,16(s0)
    10c2:	ec14                	sd	a3,24(s0)
    10c4:	f018                	sd	a4,32(s0)
    10c6:	f41c                	sd	a5,40(s0)
    10c8:	03043823          	sd	a6,48(s0)
    10cc:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    10d0:	00840613          	addi	a2,s0,8
    10d4:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    10d8:	85aa                	mv	a1,a0
    10da:	4505                	li	a0,1
    10dc:	d0dff0ef          	jal	de8 <vprintf>
}
    10e0:	60e2                	ld	ra,24(sp)
    10e2:	6442                	ld	s0,16(sp)
    10e4:	6125                	addi	sp,sp,96
    10e6:	8082                	ret

00000000000010e8 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    10ea:	e422                	sd	s0,8(sp)
    10ec:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    10ee:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10f2:	00001797          	auipc	a5,0x1
    10f6:	f1e7b783          	ld	a5,-226(a5) # 2010 <freep>
    10fa:	a02d                	j	1124 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    10fc:	4618                	lw	a4,8(a2)
    10fe:	9f2d                	addw	a4,a4,a1
    1100:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1104:	6398                	ld	a4,0(a5)
    1106:	6310                	ld	a2,0(a4)
    1108:	a83d                	j	1146 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    110a:	ff852703          	lw	a4,-8(a0)
    110e:	9f31                	addw	a4,a4,a2
    1110:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1112:	ff053683          	ld	a3,-16(a0)
    1116:	a091                	j	115a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1118:	6398                	ld	a4,0(a5)
    111a:	00e7e463          	bltu	a5,a4,1122 <free+0x3a>
    111e:	00e6ea63          	bltu	a3,a4,1132 <free+0x4a>
{
    1122:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1124:	fed7fae3          	bgeu	a5,a3,1118 <free+0x30>
    1128:	6398                	ld	a4,0(a5)
    112a:	00e6e463          	bltu	a3,a4,1132 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    112e:	fee7eae3          	bltu	a5,a4,1122 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1132:	ff852583          	lw	a1,-8(a0)
    1136:	6390                	ld	a2,0(a5)
    1138:	02059813          	slli	a6,a1,0x20
    113c:	01c85713          	srli	a4,a6,0x1c
    1140:	9736                	add	a4,a4,a3
    1142:	fae60de3          	beq	a2,a4,10fc <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    1146:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    114a:	4790                	lw	a2,8(a5)
    114c:	02061593          	slli	a1,a2,0x20
    1150:	01c5d713          	srli	a4,a1,0x1c
    1154:	973e                	add	a4,a4,a5
    1156:	fae68ae3          	beq	a3,a4,110a <free+0x22>
    p->s.ptr = bp->s.ptr;
    115a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
...
malloc(uint nbytes)
{
    ...
    1174:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1176:	02051493          	slli	s1,a0,0x20
    117a:	9081                	srli	s1,s1,0x20
    117c:	04bd                	addi	s1,s1,15
    117e:	8091                	srli	s1,s1,0x4
    1180:	0014899b          	addiw	s3,s1,1
    1184:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1186:	00001517          	auipc	a0,0x1
    118a:	e8a53503          	ld	a0,-374(a0) # 2010 <freep>
    118e:	c915                	beqz	a0,11c2 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1194:	08977a63          	bgeu	a4,s1,1228 <malloc+0xbe>
  ...
  if(nu < 4096)
    11a0:	8a4e                	mv	s4,s3
    11a2:	0009871b          	sext.w	a4,s3
    11a6:	6685                	lui	a3,0x1
    11a8:	00d77363          	bgeu	a4,a3,11ae <malloc+0x44>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    11b6:	00001917          	auipc	s2,0x1
    11ba:	e5a90913          	addi	s2,s2,-422 # 2010 <freep>
  if(p == SBRK_ERROR)
    11be:	5afd                	li	s5,-1
    11c0:	a081                	j	1200 <malloc+0x96>
    11c2:	f04a                	sd	s2,32(sp)
    ...
    if(p->s.size >= nunits){
    11e0:	b7c1                	j	11a0 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    11e2:	6398                	ld	a4,0(a5)
    11e4:	e118                	sd	a4,0(a0)
    11e6:	a8a9                	j	1240 <malloc+0xd6>
  hp->s.size = nu;
    11e8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11ec:	0541                	addi	a0,a0,16
    11ee:	efbff0ef          	jal	10e8 <free>
  return freep;
    11f2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    11f6:	c12d                	beqz	a0,1258 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11fa:	4798                	lw	a4,8(a5)
    11fc:	02977263          	bgeu	a4,s1,1220 <malloc+0xb6>
    if(p == freep)
    1200:	00093703          	ld	a4,0(s2)
    1204:	853e                	mv	a0,a5
    1206:	fef719e3          	bne	a4,a5,11f8 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    120a:	8552                	mv	a0,s4
    120c:	933ff0ef          	jal	b3e <sbrk>
  if(p == SBRK_ERROR)
    1210:	fd551ce3          	bne	a0,s5,11e8 <malloc+0x7e>
        return 0;
    1214:	4501                	li	a0,0
